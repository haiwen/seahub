...
from .views import dtable_file_view, dtable_asset_access, dtable_asset_file_view, dtable_forms_view
...
urlpatterns = [
    ...
    url(r'^dtable/forms/(?P<token>[-0-9a-f]{36})$', dtable_forms_view, name='dtable_forms_view')
]
