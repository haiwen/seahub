...
urlpatterns = patterns('',
    ...
    url(r'^repo/(?P<repo_id>[-0-9a-f]{36})/basic_info/$', repo_basic_info, name='repo_basic_info'),
    url(r'^repo/(?P<repo_id>[-0-9a-f]{36})/transfer_owner/$', repo_transfer_owner, name='repo_transfer_owner'),
    url(r'^repo/(?P<repo_id>[-0-9a-f]{36})/change_password/$', repo_change_password, name='repo_change_password'),
    url(r'^repo/(?P<repo_id>[-0-9a-f]{36})/shared_link/$', repo_shared_link, name='repo_shared_link'),
    url(r'^repo/(?P<repo_id>[-0-9a-f]{36})/share_manage/$', repo_share_manage, name='repo_share_manage'),
    url(r'^repo/(?P<repo_id>[-0-9a-f]{36})/folder_perm/$', repo_folder_perm, name='repo_folder_perm'),
   ...
   (r'^file_upload_progress_page/$', file_upload_progress_page),
    ...
    url(r'^ajax/repo/(?P<repo_id>[-0-9a-f]{36})/basic_info/$', ajax_repo_change_basic_info, name='ajax_repo_change_basic_info'),
    url(r'^ajax/repo/(?P<repo_id>[-0-9a-f]{36})/owner/$', ajax_repo_transfer_owner, name='ajax_repo_transfer_owner'),
    url(r'^ajax/repo/(?P<repo_id>[-0-9a-f]{36})/passwd/$', ajax_repo_change_passwd, name='ajax_repo_change_passwd'),
    url(r'^ajax/repo/(?P<repo_id>[-0-9a-f]{36})/user_folder_permission/add/$', add_user_folder_permission, name='add_user_folder_permission'),
    url(r'^ajax/repo/(?P<repo_id>[-0-9a-f]{36})/user_folder_permission/remove/$', remove_user_folder_permission, name='remove_user_folder_permission'),
    url(r'^ajax/repo/(?P<repo_id>[-0-9a-f]{36})/user_folder_permission/toggle/$', toggle_user_folder_permission, name='toggle_user_folder_permission'),
    url(r'^ajax/repo/(?P<repo_id>[-0-9a-f]{36})/group_folder_permission/add/$', add_group_folder_permission, name='add_group_folder_permission'),
    url(r'^ajax/repo/(?P<repo_id>[-0-9a-f]{36})/group_folder_permission/remove/$', remove_group_folder_permission, name='remove_group_folder_permission'),
    url(r'^ajax/repo/(?P<repo_id>[-0-9a-f]{36})/group_folder_permission/toggle/$', toggle_group_folder_permission, name='toggle_group_folder_permission'),
