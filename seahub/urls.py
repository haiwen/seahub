...
from seahub.api2.endpoints.repo_api_tokens import RepoAPITokensView, RepoAPITokenView, RepoJwtTokenView
...
urlpatterns = [
    ...
    re_path(r'^api/v2.1/repos/(?P<repo_id>[-0-9a-f]{36})/repo-jwt-token/$', RepoJwtTokenView.as_view(), name='api-v2.1-repo-jwt-token'),
