...
from seahub.api2.endpoints.dtable import WorkspacesView, WorkspaceView, DTableView, \
     DTableUpdateLinkView, DTableUploadLinkView, dtable_file_view
...
urlpatterns = [
    ...
    url(r'^api/v2.1/workspace/(?P<workspace_id>\d+)/dtable-upload-link/$', DTableUploadLinkView.as_view(), name='api-v2.1-workspace-dtable-upload-link'),
