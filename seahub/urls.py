...
urlpatterns = [
    ...
    url(r'api/v2.1/ocm/shares-prepare/(?P<shared_secret>\w+)/$', OCMSharePrepareView.as_view(), name='api-v2.1-ocm-share-prepare'),
    url(r'api/v2.1/ocm/shares-received/$', OCMSharesReceivedView.as_view(), name='api-v2.1-ocm-shares-received'),
    url(r'api/v2.1/ocm/shares-received/(?P<shared_secret>\w+)/$', OCMShareReceivedView.as_view(), name='api-v2.1-ocm-share-received'),
