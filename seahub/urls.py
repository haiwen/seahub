...
from seahub.api2.endpoints.internal_api import InternalUserListView, InternalCheckShareLinkAccess, \
    ...
    CheckThumbnailAccessByUserToken, InternalConvertSeadocImage
...
from seahub.api2.endpoints.wiki2 import Wiki2FileRepo, Wiki2FileRepoDuplicateView, Wiki2FileRepos, Wikis2View, Wiki2View, Wiki2ConfigView, Wiki2PagesView, Wiki2PageView, \
    ...
    Wiki2SettingsView, Wiki2LinkedReposView, Wiki2FileRepoViewRecords, Wiki2ViewDuplicateView
...
urlpatterns = [
    ...
    re_path(r'^repo/(?P<repo_id>[-0-9a-f]{36})/sdoc/(?P<file_uuid>[-0-9a-f]{36})/preview/$', sdoc_preview, name='sdoc_preview'),
    ...
    re_path(r'^api/v2.1/wiki2/(?P<wiki_id>[-0-9a-f]{36})/duplicate-view/$', Wiki2ViewDuplicateView.as_view(), name='api-v2.1-wiki2-duplicate-view'),
    ...
    re_path(r'^api/v2.1/wiki2/(?P<wiki_id>[-0-9a-f]{36})/file-repos/$', Wiki2FileRepos.as_view(), name='api-v2.1-wiki2-file-repos'),
    re_path(r'^api/v2.1/wiki2/(?P<wiki_id>[-0-9a-f]{36})/file-repos/(?P<file_repo_id>\d+)/$', Wiki2FileRepo.as_view(), name='api-v2.1-wiki2-file-repo'),
    re_path(r'^api/v2.1/wiki2/(?P<wiki_id>[-0-9a-f]{36})/file-repos/(?P<file_repo_id>\d+)/duplicate/$', Wiki2FileRepoDuplicateView.as_view(), name='api-v2.1-wiki2-file-view-duplicate'),
    re_path(r'^api/v2.1/wiki2/(?P<wiki_id>[-0-9a-f]{36})/file-repo/(?P<file_repo_id>\d+)/views/$', Wiki2Views.as_view(), name='api-v2.1-wiki2-views'),
    re_path(r'^api/v2.1/wiki2/(?P<wiki_id>[-0-9a-f]{36})/file-repo/(?P<file_repo_id>\d+)/views/(?P<view_id>[^/]+)/$', Wiki2View.as_view(), name='api-v2.1-wiki2-view'),
    re_path(r'^api/v2.1/wiki2/(?P<wiki_id>[-0-9a-f]{36})/file-repo/(?P<file_repo_id>\d+)/views/(?P<view_id>[^/]+)/records/$', Wiki2FileRepoViewRecords.as_view(), name='api-v2.1-wiki2-metadata-records'),
