...
urlpatterns = [
    ...
    path('sys/libraries/all/', sysadmin_react_fake_view, name="sys_all_libraries"),
    path('sys/libraries/wikis/', sysadmin_react_fake_view, name="sys_all_wikis"),
    path('sys/search-libraries/', sysadmin_react_fake_view, name="sys_search_libraries"),
    path('sys/libraries/system/', sysadmin_react_fake_view, name="sys_system_library"),
    path('sys/libraries/trash/', sysadmin_react_fake_view, name="sys_trash_libraries"),
