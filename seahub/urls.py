...
from seahub.api2.endpoints.wiki2 import Wiki2FileRepo, Wiki2FileRepoDuplicateView, Wiki2FileRepos, Wikis2View, Wiki2View, Wiki2ConfigView, Wiki2PagesView, Wiki2PageView, \
    ...
    Wiki2SettingsView, Wiki2LinkedReposView, Wiki2FileRepoRecords
...
urlpatterns = [
    ...
    re_path(r'^api/v2.1/wiki2/(?P<wiki_id>[-0-9a-f]{36})/file-repo/(?P<file_repo_id>\d+)/records/$', Wiki2FileRepoRecords.as_view(), name='api-v2.1-wiki2-metadata-records'),
