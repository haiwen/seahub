...
from seahub.api2.endpoints.repo_drafts_reviews import RepoDraftsReviews
...
urlpatterns = [
    ...
    url(r'^api/v2.1/draft-review-info/(?P<repo_id>[-0-9a-f]{36})/$', RepoDraftsReviews.as_view(), name='api-v2.1-drafts-reviews' ),
