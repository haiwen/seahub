...
from seahub.api2.endpoints.repos_batch import ReposBatchView, \
        ...
        ReposBatchDeleteItemView, SpanReposBatchDelete
...
urlpatterns = [
    ...
    re_path(r'^api/v2.1/repos/span-batch-delete-item/$', SpanReposBatchDelete.as_view(), name='api-v2.1-repos-span-batch-delete'),
