...
from seahub.seadoc.views import sdoc_revision, sdoc_revisions, sdoc_to_docx, sdoc_thumbnail
...
urlpatterns = [
    ...
    re_path(r'^repo/(?P<repo_id>[-0-9a-f]{36})/sdoc/(?P<file_uuid>[-0-9a-f]{36})/thumbnail/$', sdoc_thumbnail, name='sdoc_thumbnail'),
