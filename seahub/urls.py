...
from seahub.api2.endpoints.groups_share import GroupsSharableView
...
urlpatterns = patterns(
    ...
    url(r'^api/v2.1/groups/sharable/$', GroupsSharableView.as_view(), name='api-v2.1-groups-sharable'),
