...
urlpatterns = [
    ...
    url(r'^api/v2.1/address-book/departments/$', AddressBookDepartments.as_view(), name='api-v2.1-address-book-groups-departments'),
    url(r'^api/v2.1/address-book/departments/(?P<department_id>\d+)/members/$', AddressBookDepartmentMembers.as_view(), name='api-v2.1-address-book-groups-department-members'),
