...
from seahub.api2.endpoints.wiki2 import Wikis2View, Wiki2View, Wiki2ConfigView, Wiki2PagesView, Wiki2PageView, \
    ...
    Wiki2SettingsView, Wiki2LinkedReposView, Wiki2FileViewRecords, Wiki2FileViewDuplicateView, Wiki2SetPublicView
...
urlpatterns = [
    ...
    re_path(r'^api/v2.1/wiki2/(?P<wiki_id>[-0-9a-f]{36})/set-public/$', Wiki2SetPublicView.as_view(), name='api-v2.1-wiki2-set-public'),
    ## user::drafts
