...
from seahub.api2.endpoints.admin.logs import AdminLogsLogin, AdminLogsFileAccess, AdminLogsFileUpdate, \
    AdminLogsSharePermission
...
urlpatterns = [
    ...
    ## admin::logs
    url(r'^api/v2.1/admin/logs/login-logs/$', AdminLogsLogin.as_view(), name='api-v2.1-admin-logs-login-logs'),
    url(r'^api/v2.1/admin/logs/file-access-logs/$', AdminLogsFileAccess.as_view(), name='api-v2.1-admin-logs-file-access-logs'),
    url(r'^api/v2.1/admin/logs/file-update-logs/$', AdminLogsFileUpdate.as_view(), name='api-v2.1-admin-logs-file-update-logs'),
    url(r'^api/v2.1/admin/logs/share-permission-logs/$', AdminLogsSharePermission.as_view(), name='api-v2.1-admin-logs-share-permission-logs'),
