...
urlpatterns = [
    ...
    re_path(r'^api/v2.1/wikis/(?P<wiki_id>[^/]+)/$', WikiView.as_view(), name='api-v2.1-wiki'),
    re_path(r'^api/v2.1/wikis/(?P<wiki_id>[^/]+)/dir/$', WikiPagesDirView.as_view(), name='api-v2.1-wiki-pages-dir'),
    re_path(r'^api/v2.1/wiki-config/(?P<wiki_id>[^/]+)/$', WikiConfigView.as_view(), name='api-v2.1-wiki-config'),
    re_path(r'^api/v2.1/wikis/(?P<wiki_id>[^/]+)/content/$', WikiPageContentView.as_view(), name='api-v2.1-wiki-pages-content'),
    ...
    re_path(r'^edit-wiki/(?P<wiki_id>\d+)/(?P<file_path>.*)$', edit_slug, name='edit_slug'),
