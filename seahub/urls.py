...
from seahub.api2.endpoints.starred_items import StarredItems, StarredItem
...
urlpatterns = [
    ...
    url(r'^api/v2.1/starred-items/(?P<pk>\d+)/$', StarredItem.as_view(), name='api-v2.1-starred-item'),
