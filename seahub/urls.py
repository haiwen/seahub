...
from seahub.api2.endpoints.admin.org_users import AdminOrgStaff, AdminOrgUsers, AdminOrgUser
...
urlpatterns = [
    ...
    re_path(r'^api/v2.1/admin/organizations/(?P<org_id>\d+)/staff/$', AdminOrgStaff.as_view(), name='api-v2.1-admin-org-staff'),
    ...
    path('sys/organizations/<int:org_id>/staff/', sysadmin_react_fake_view, name="sys_organization_staff"),
