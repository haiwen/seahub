...
urlpatterns = [
    ...
    url(r'^api/v2.1/repos/(?P<repo_id>[-0-9a-f]{36})/file/participants/batch-add/$', FileParticipantsBatchAddView.as_view(), name='api-v2.1-file-participants-batch-add'),
