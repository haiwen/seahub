...
from seahub.seadoc.views import sdoc_revision, sdoc_revisions, sdoc_export_revision
...
urlpatterns = [
    ...
    re_path(r'^repo/export_sdoc_revision/(?P<repo_id>[-0-9a-f]{36})/$', sdoc_export_revision, name='sdoc_export_revision'),
