...
from seahub.seadoc.views import sdoc_revision, sdoc_revisions, sdoc_export_history
...
urlpatterns = [
    ...
    re_path(r'^repo/sdoc_export_history/(?P<repo_id>[-0-9a-f]{36})/$', sdoc_export_history, name='sdoc_export_history'),
