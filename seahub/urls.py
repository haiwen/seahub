...
from seahub.api2.endpoints.user import User, UserResetLoginPassword
...
urlpatterns = [
    ...
    re_path(r'^api/v2.1/user-reset-login-password/$', UserResetLoginPassword.as_view(), name="api-v2.1-user-reset-login-password"),
