...
from seahub.repo_metadata.utils import add_init_metadata_task, gen_unique_id, init_metadata, \
    get_unmodifiable_columns, can_read_metadata, init_faces, get_table_by_name, \
    extract_file_details, remove_faces_table, FACES_SAVE_PATH, \
    ...
    def put(self, request, repo_id):
        ...
        for file_tags in file_tags_data:
            ...
            if not record_id:
                continue
            try:
                metadata_server_api.update_link(TAGS_TABLE.link_id, METADATA_TABLE.id, {record_id: tags})
