...
VERIFY_CODE_CACHE_TIMEOUT = getattr(settings, 'VERIFY_CODE_CACHE_TIMEOUT', 10 * 60)
VERIFY_CODE_CACHE_PREFIX = getattr(settings, 'VERIFY_CODE_CACHE_PREFIX', 'VERIFY_CODE_')
