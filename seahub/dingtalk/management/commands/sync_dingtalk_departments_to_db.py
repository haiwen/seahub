...
class Command(BaseCommand):
    help = "Sync the imported dingtalk departments to the database."
    ...
    def handle(self, *args, **options):
        self.log_debug('Start sync dingtalk departments...')
        self.do_action()
        self.log_debug('Finish sync dingtalk departments.\n')
