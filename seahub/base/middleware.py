...
from seahub.organizations.utils import generate_org_re_active_link
from seahub.notifications.models import Notification
from seahub.notifications.utils import refresh_cache
from seahub.api2.utils import api_error

from seahub.settings import SITE_ROOT, SUPPORT_EMAIL
from seahub.organizations.settings import ORG_ENABLE_RE_ACTIVE
try:
...
class BaseMiddleware(MiddlewareMixin):
    ...
    def process_request(self, request):
        ...
        if ORG_ENABLE_RE_ACTIVE and is_org_staff:
            re_active_link = generate_org_re_active_link(org_id, ccnet_email)
            extra_ctx["re_active_link"] = re_active_link
