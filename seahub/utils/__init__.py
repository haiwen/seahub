...
if EVENTS_CONFIG_FILE:
    ...
    def _get_activities(username, op_user, start, count):
    ...
    def get_user_activities(username, op_user, start, count):
        ...
        ``get_user_activities('foo@example.com', 4, 10)`` returns the 6th through
                 15th events.
        """
        return _get_activities(username, op_user, start, count)
