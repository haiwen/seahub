...
from seahub.ai.utils import image_caption, translate, writing_assistant, verify_ai_config, generate_summary, \
    generate_file_tags, ocr, generate_icon, is_ai_usage_over_limit, gen_chat_task_id, gen_message_id, \
...
class AIGenerateIcon(APIView):
    ...
    def post(self, request):
        ...
        if not wiki_name:
            return api_error(status.HTTP_400_BAD_REQUEST, 'wiki_name invalid')
