...
from seahub.wiki2.utils import is_valid_wiki_name, \
    get_wiki_config, WIKI_PAGES_DIR, is_group_wiki, \
...
from seahub.utils import is_org_context, get_user_repos, \
    is_pro_version, is_valid_dirent_name, get_no_duplicate_obj_name, \
