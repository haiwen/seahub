...
def get_dir_file_info_list(username, request_type, repo_obj, parent_dir,
    ...
    try:
        ...
        for item in starred_items:
            starred_items_dict[item.path.rstrip('/')] = item.id
    ...
    if not request_type or request_type == 'd':
        ...
        for dirent in dir_list:
            ...
            dir_info['star_item_id'] = ''
            dir_path = posixpath.join(parent_dir, dirent.obj_name)
            if dir_path.rstrip('/') in starred_items_dict:
                dir_info['starred'] = True
                dir_info['star_item_id'] = starred_items_dict[dir_path.rstrip('/')]
    ...
    if not request_type or request_type == 'f':
        ...
        for dirent in file_list:
            ...
            file_info['star_item_id'] = ''
            if file_path.rstrip('/') in starred_items_dict:
                file_info['starred'] = True
                file_info['star_item_id'] = starred_items_dict[file_path.rstrip('/')]
