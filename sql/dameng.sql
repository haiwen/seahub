...
CREATE TABLE IF NOT EXISTS "REPO_TRANSFER" ("ID" INTEGER PRIMARY KEY AUTO_INCREMENT,"REPO_ID" VARCHAR(36) NOT NULL,"ORG_ID" INT NOT NULL,"FROM_USER" VARCHAR(255) NOT NULL,"TO" VARCHAR(255) NOT NULL,"TIMESTAMP" DATETIME NOT NULL,"OPERATOR" VARCHAR(255) NOT NULL)
CREATE INDEX IF NOT EXISTS "IDX_FILE_TRANSFER_ORG_ID" ON "REPO_TRANSFER" ("ORG_ID");
CREATE INDEX IF NOT EXISTS "IDX_FILE_TRANSFER_TIMESTAMP" ON "REPO_TRANSFER" ("TIMESTAMP");
CREATE TABLE IF NOT EXISTS "GROUP_INVITE_LINK" ("ID" INTEGER PRIMARY KEY AUTO_INCREMENT,"TOKEN" VARCHAR(40) NOT NULL,"GROUP_ID" INT NOT NULL,"CREATED_AT" DATETIME(6) NOT NULL,"CREATED_BY" VARCHAR(255) NOT NULL)
...
CREATE TABLE IF NOT EXISTS "GROUP_MEMBER_AUDIT" ("ID" INTEGER PRIMARY KEY AUTO_INCREMENT,"ORG_ID" INT NOT NULL,"OPERATOR" VARCHAR(255) NOT NULL,"USER" VARCHAR(255) NOT NULL,"GROUP_ID" INT NOT NULL,"OPERATION" VARCHAR(128) NOT NULL,"TIMESTAMP" DATETIME NOT NULL)
...
CREATE TABLE IF NOT EXISTS "NOTIFICATIONS_SYSUSERNOTIFICATION" ("ID" INTEGER PRIMARY KEY AUTO_INCREMENT,"MESSAGE" TEXT NOT NULL,"TO_USER" VARCHAR(255) NOT NULL,"SEEN" TINYINT NOT NULL,"CREATED_AT" DATETIME(6) NOT NULL)
...
CREATE TABLE IF NOT EXISTS "USER_QUOTA_USAGE" ("ID" INTEGER PRIMARY KEY AUTO_INCREMENT,"USERNAME" VARCHAR(255) NOT NULL,"ORG_ID" INT NOT NULL,"QUOTA" BIGINT DEFAULT NULL,"USAGE" BIGINT DEFAULT NULL,"TIMESTAMP" DATETIME NOT NULL,UNIQUE ("USERNAME"))
...
CREATE TABLE IF NOT EXISTS "ORG_QUOTA_USAGE" ("ID" INTEGER PRIMARY KEY AUTO_INCREMENT,"ORG_ID" INT NOT NULL,"QUOTA" BIGINT DEFAULT NULL,"USAGE" BIGINT DEFAULT NULL,"TIMESTAMP" DATETIME NOT NULL,UNIQUE ("ORG_ID"))
CREATE INDEX IF NOT EXISTS "IDX_ORG_QUOTA_USAGE_TIMESTAMP" ON "ORG_QUOTA_USAGE" ("TIMESTAMP");
CREATE TABLE IF NOT EXISTS "STATS_AI_BY_TEAM" ("ID" BIGINT PRIMARY KEY AUTO_INCREMENT,"ORG_ID" BIGINT NOT NULL,"MONTH" DATE NOT NULL,"MODEL" VARCHAR(100) NOT NULL,"INPUT_TOKENS" INT DEFAULT NULL,"OUTPUT_TOKENS" INT DEFAULT NULL,"COST" DOUBLE NOT NULL,"CREATED_AT" DATETIME(6) DEFAULT NULL,"UPDATED_AT" DATETIME(6) DEFAULT NULL,UNIQUE ("ORG_ID", "MONTH", "MODEL"))
CREATE INDEX IF NOT EXISTS "IX_STATS_AI_BY_TEAM_ORG_ID_MONTH" ON "STATS_AI_BY_TEAM" ("ORG_ID", "MONTH");
CREATE TABLE IF NOT EXISTS "STATS_AI_BY_OWNER" ("ID" BIGINT PRIMARY KEY AUTO_INCREMENT,"USERNAME" VARCHAR(255) NOT NULL,"MONTH" DATE NOT NULL,"MODEL" VARCHAR(100) NOT NULL,"INPUT_TOKENS" INT DEFAULT NULL,"OUTPUT_TOKENS" INT DEFAULT NULL,"COST" DOUBLE NOT NULL,"CREATED_AT" DATETIME(6) DEFAULT NULL,"UPDATED_AT" DATETIME(6) DEFAULT NULL,UNIQUE ("USERNAME", "MONTH", "MODEL"))
