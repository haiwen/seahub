...
CREATE TABLE IF NOT EXISTS "ADMIN_LOG_ADMINLOG" ("ID" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT, "EMAIL" VARCHAR(254) NOT NULL, "OPERATION" VARCHAR(255) NOT NULL, "DETAIL" TEXT NOT NULL, "TIMESTAMP" TIMESTAMP NOT NULL);
...
CREATE TABLE IF NOT EXISTS "USERACTIVITY" ("ID" BIGINT PRIMARY KEY AUTO_INCREMENT,"USERNAME" VARCHAR(255) NOT NULL,"ACTIVITY_ID" TIMESTAMP DEFAULT NULL,"TIMESTAMP" TIMESTAMP NOT NULL);
