...
CREATE TABLE IF NOT EXISTS "FILETRASH" ("ID" INTEGER PRIMARY KEY AUTO_INCREMENT,"USERNAME" VARCHAR(255) NOT NULL,"OBJ_TYPE" VARCHAR(10) NOT NULL,"OBJ_ID" VARCHAR(40) NOT NULL,"OBJ_NAME" VARCHAR(255) NOT NULL,"DELETE_TIME" TIMESTAMP NOT NULL,"REPO_ID" VARCHAR(36) NOT NULL,"COMMIT_ID" VARCHAR(40) DEFAULT NULL,"PATH" TEXT NOT NULL,"FILE_SIZE" INTEGER NOT NULL);
