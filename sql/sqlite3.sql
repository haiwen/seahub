...
CREATE TABLE IF NOT EXISTS "ai_review_task" ("id" varchar(36) NOT NULL PRIMARY KEY, "chat_session_id" varchar(36) NOT NULL, "assistant_message_id" bigint NULL UNIQUE, "repo_id" varchar(36) NOT NULL, "path" text NOT NULL, "file_uuid" varchar(36) NOT NULL, "requester" varchar(255) NOT NULL, "prompt" text NOT NULL, "route" varchar(32) NOT NULL, "org_id" bigint NULL, "message_id" varchar(4) NULL, "allowed_block_ids" text NOT NULL, "allowed_text_targets" text NOT NULL, "scope_summary" text NOT NULL, "scope_snapshot_id" varchar(36) NULL, "scope_document_incarnation" varchar(36) NULL, "scope_sdoc_version" bigint NULL, "generation_status" varchar(32) NOT NULL, "generation_revision" integer NOT NULL, "generation_attempt_id" varchar(36) NULL, "generation_deadline_at" datetime NULL, "error_code" varchar(64) NULL, "total_chunks" integer NOT NULL, "completed_chunks" integer NOT NULL, "total_review_blocks" integer NOT NULL, "completed_review_blocks" integer NOT NULL, "generation_truncated" bool NOT NULL, "generation_stop_reason" varchar(64) NULL, "generation_finished_at" datetime NULL, "base_sdoc_version" bigint NULL, "current_changeset_revision_id" varchar(36) NULL, "current_card_revision_id" varchar(36) NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE INDEX IF NOT EXISTS "ai_review_task_chat_session_id" ON "ai_review_task" ("chat_session_id");
CREATE INDEX IF NOT EXISTS "ai_review_task_repo_id" ON "ai_review_task" ("repo_id");
CREATE INDEX IF NOT EXISTS "ai_review_task_file_uuid" ON "ai_review_task" ("file_uuid");
CREATE INDEX IF NOT EXISTS "ai_review_task_generation_status" ON "ai_review_task" ("generation_status");
CREATE INDEX IF NOT EXISTS "ai_review_task_generation_attempt_id" ON "ai_review_task" ("generation_attempt_id");
CREATE TABLE IF NOT EXISTS "ai_review_changeset_revision" ("id" varchar(36) NOT NULL PRIMARY KEY, "review_task_id" varchar(36) NOT NULL, "changeset_revision" integer NOT NULL, "snapshot_id" varchar(36) NOT NULL, "file_uuid" varchar(36) NOT NULL, "document_incarnation" varchar(36) NOT NULL, "exact_sdoc_version" bigint NOT NULL, "projection_version" varchar(64) NOT NULL, "scope_summary" text NOT NULL, "revision_brief" text NOT NULL, "created_at" datetime NOT NULL, UNIQUE ("review_task_id", "changeset_revision"));
CREATE INDEX IF NOT EXISTS "ai_review_changeset_revision_file_uuid" ON "ai_review_changeset_revision" ("file_uuid");
CREATE TABLE IF NOT EXISTS "ai_review_generation_chunk" ("id" varchar(36) NOT NULL PRIMARY KEY, "review_task_id" varchar(36) NOT NULL, "generation_attempt_id" varchar(36) NOT NULL, "chunk_index" integer NOT NULL, "block_count" integer NOT NULL, "created_item_count" integer NOT NULL, "created_at" datetime NOT NULL, UNIQUE ("review_task_id", "generation_attempt_id", "chunk_index"));
CREATE TABLE IF NOT EXISTS "ai_review_change_item" ("id" varchar(36) NOT NULL PRIMARY KEY, "item_id" varchar(36) NOT NULL, "changeset_revision_id" varchar(36) NOT NULL, "logical_item_id" varchar(36) NULL, "target_key" varchar(160) NULL, "kind" varchar(64) NOT NULL, "target" text NOT NULL, "precondition" text NOT NULL, "preview" text NOT NULL, "after_text" text NOT NULL, "after_type" varchar(64) NULL, "rationale" text NOT NULL, "sort_order" integer NOT NULL, "created_at" datetime NOT NULL, UNIQUE ("changeset_revision_id", "item_id"), UNIQUE ("changeset_revision_id", "target_key"));
CREATE INDEX IF NOT EXISTS "ai_review_change_item_item_id" ON "ai_review_change_item" ("item_id");
CREATE INDEX IF NOT EXISTS "ai_review_change_item_logical_item_id" ON "ai_review_change_item" ("logical_item_id");
CREATE TABLE IF NOT EXISTS "ai_review_card_revision" ("id" varchar(36) NOT NULL PRIMARY KEY, "review_task_id" varchar(36) NOT NULL, "changeset_revision_id" varchar(36) NOT NULL, "card_revision" integer NOT NULL, "supersedes_decision_id" varchar(36) NULL, "created_at" datetime NOT NULL, UNIQUE ("review_task_id", "card_revision"));
CREATE INDEX IF NOT EXISTS "ai_review_card_revision_changeset_revision_id" ON "ai_review_card_revision" ("changeset_revision_id");
CREATE TABLE IF NOT EXISTS "ai_review_card_revision_item" ("id" varchar(36) NOT NULL PRIMARY KEY, "card_revision_item_id" varchar(36) NOT NULL, "card_revision_id" varchar(36) NOT NULL, "change_item_id" varchar(36) NOT NULL, "reviewable" bool NOT NULL, "conflicted" bool NOT NULL, "selectable" bool NOT NULL, "conflict_summary" text NULL, "created_at" datetime NOT NULL, UNIQUE ("card_revision_id", "change_item_id"));
CREATE INDEX IF NOT EXISTS "ai_review_card_rev_item_card_item_id" ON "ai_review_card_revision_item" ("card_revision_item_id");
CREATE INDEX IF NOT EXISTS "ai_review_card_rev_item_change_item_id" ON "ai_review_card_revision_item" ("change_item_id");
CREATE TABLE IF NOT EXISTS "ai_review_decision" ("id" varchar(36) NOT NULL PRIMARY KEY, "review_decision_id" varchar(36) NOT NULL UNIQUE, "card_revision_id" varchar(36) NOT NULL, "decision_kind" varchar(16) NOT NULL, "selection_digest" varchar(64) NOT NULL, "operator" varchar(255) NOT NULL, "created_at" datetime NOT NULL);
CREATE INDEX IF NOT EXISTS "ai_review_decision_card_revision_id" ON "ai_review_decision" ("card_revision_id");
CREATE TABLE IF NOT EXISTS "ai_review_decision_selection" ("id" varchar(36) NOT NULL PRIMARY KEY, "decision_id" varchar(36) NOT NULL, "card_revision_item_id" varchar(36) NOT NULL, UNIQUE ("decision_id", "card_revision_item_id"), UNIQUE ("card_revision_item_id"));
CREATE INDEX IF NOT EXISTS "ai_review_decision_selection_card_revision_item_id" ON "ai_review_decision_selection" ("card_revision_item_id");
CREATE TABLE IF NOT EXISTS "ai_review_apply_attempt" ("id" varchar(36) NOT NULL PRIMARY KEY, "apply_attempt_id" varchar(36) NOT NULL UNIQUE, "review_decision_id" varchar(36) NOT NULL UNIQUE, "status" varchar(32) NOT NULL, "persistence_status" varchar(32) NOT NULL, "verification_status" varchar(32) NOT NULL, "approved_by" varchar(255) NOT NULL, "selection_digest" varchar(64) NOT NULL, "apply_payload_digest" varchar(64) NOT NULL, "card_revision_number" integer NOT NULL, "changeset_revision_number" integer NOT NULL, "snapshot_id" varchar(36) NOT NULL, "document_incarnation" varchar(36) NOT NULL, "applied_sdoc_version" bigint NULL, "operation_log_correlation_id" varchar(36) NULL, "result_query_deadline_at" datetime NULL, "error_code" varchar(64) NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE INDEX IF NOT EXISTS "ai_review_apply_attempt_status" ON "ai_review_apply_attempt" ("status");
COMMIT;
