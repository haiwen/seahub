...
INSERT INTO "django_migrations" VALUES(1,'admin_log','0001_initial','2017-05-09 06:25:06.330835');
INSERT INTO "django_migrations" VALUES(2,'captcha','0001_initial','2017-05-09 06:25:06.343387');
INSERT INTO "django_migrations" VALUES(3,'contenttypes','0001_initial','2017-05-09 06:25:06.377900');
INSERT INTO "django_migrations" VALUES(4,'contenttypes','0002_remove_content_type_name','2017-05-09 06:25:06.420319');
INSERT INTO "django_migrations" VALUES(5,'database','0001_initial','2017-05-09 06:25:06.431738');
INSERT INTO "django_migrations" VALUES(6,'institutions','0001_initial','2017-05-09 06:25:06.457291');
INSERT INTO "django_migrations" VALUES(7,'institutions','0002_institutionquota','2017-05-09 06:25:06.477604');
INSERT INTO "django_migrations" VALUES(8,'invitations','0001_initial','2017-05-09 06:25:06.492328');
INSERT INTO "django_migrations" VALUES(9,'invitations','0002_invitation_invite_type','2017-05-09 06:25:06.509230');
INSERT INTO "django_migrations" VALUES(10,'invitations','0003_auto_20160510_1703','2017-05-09 06:25:06.539263');
INSERT INTO "django_migrations" VALUES(11,'invitations','0004_auto_20160629_1610','2017-05-09 06:25:06.573480');
INSERT INTO "django_migrations" VALUES(12,'invitations','0005_auto_20160629_1614','2017-05-09 06:25:06.589944');
INSERT INTO "django_migrations" VALUES(13,'post_office','0001_initial','2017-05-09 06:25:06.688264');
INSERT INTO "django_migrations" VALUES(14,'post_office','0002_add_i18n_and_backend_alias','2017-05-09 06:25:07.165740');
INSERT INTO "django_migrations" VALUES(15,'sessions','0001_initial','2017-05-09 06:25:07.180425');
INSERT INTO "django_migrations" VALUES(16,'termsandconditions','0001_initial','2017-05-09 06:25:07.238683');
INSERT INTO "django_migrations" VALUES(17,'two_factor','0001_initial','2017-05-09 06:25:07.296701');
...
CREATE TABLE "share_fileshare" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "username" varchar(255) NOT NULL, "repo_id" varchar(36) NOT NULL, "path" text NOT NULL, "token" varchar(100) NOT NULL UNIQUE, "ctime" datetime NOT NULL, "view_cnt" integer NOT NULL, "s_type" varchar(2) NOT NULL, "password" varchar(128) NULL, "permission" varchar(50) NOT NULL, "expire_date" datetime NULL);
