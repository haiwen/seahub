...
CREATE TABLE "AI_REVIEW_TASK" ("ID" CHAR(36) NOT NULL PRIMARY KEY, "CHAT_SESSION_ID" VARCHAR2(36) NOT NULL, "ASSISTANT_MESSAGE_ID" NUMBER(19) NULL UNIQUE, "REPO_ID" VARCHAR2(36) NOT NULL, "PATH" CLOB NOT NULL, "FILE_UUID" VARCHAR2(36) NOT NULL, "REQUESTER" VARCHAR2(255) NOT NULL, "PROMPT" CLOB NOT NULL, "ROUTE" VARCHAR2(32) NOT NULL, "ORG_ID" NUMBER(19) NULL, "MESSAGE_ID" VARCHAR2(4) NULL, "ALLOWED_BLOCK_IDS" CLOB NOT NULL, "ALLOWED_TEXT_TARGETS" CLOB NOT NULL, "SCOPE_SUMMARY" CLOB NOT NULL, "SCOPE_SNAPSHOT_ID" VARCHAR2(36) NULL, "SCOPE_DOCUMENT_INCARNATION" VARCHAR2(36) NULL, "SCOPE_SDOC_VERSION" NUMBER(19) NULL, "GENERATION_STATUS" VARCHAR2(32) NOT NULL, "GENERATION_REVISION" NUMBER(11) NOT NULL, "GENERATION_ATTEMPT_ID" CHAR(36) NULL, "GENERATION_DEADLINE_AT" TIMESTAMP(6) NULL, "ERROR_CODE" VARCHAR2(64) NULL, "TOTAL_CHUNKS" NUMBER(11) NOT NULL, "COMPLETED_CHUNKS" NUMBER(11) NOT NULL, "TOTAL_REVIEW_BLOCKS" NUMBER(11) NOT NULL, "COMPLETED_REVIEW_BLOCKS" NUMBER(11) NOT NULL, "GENERATION_TRUNCATED" NUMBER(1) NOT NULL, "GENERATION_STOP_REASON" VARCHAR2(64) NULL, "GENERATION_FINISHED_AT" TIMESTAMP(6) NULL, "BASE_SDOC_VERSION" NUMBER(19) NULL, "CURRENT_CHANGESET_REVISION_ID" CHAR(36) NULL, "CURRENT_CARD_REVISION_ID" CHAR(36) NULL, "CREATED_AT" TIMESTAMP(6) NOT NULL, "UPDATED_AT" TIMESTAMP(6) NOT NULL);
CREATE INDEX "AI_REV_TASK_SESSION" ON "AI_REVIEW_TASK" ("CHAT_SESSION_ID");
CREATE INDEX "AI_REV_TASK_REPO" ON "AI_REVIEW_TASK" ("REPO_ID");
CREATE INDEX "AI_REV_TASK_FILE" ON "AI_REVIEW_TASK" ("FILE_UUID");
CREATE INDEX "AI_REV_TASK_STATUS" ON "AI_REVIEW_TASK" ("GENERATION_STATUS");
CREATE INDEX "AI_REV_TASK_ATTEMPT" ON "AI_REVIEW_TASK" ("GENERATION_ATTEMPT_ID");

CREATE TABLE "AI_REVIEW_CHANGESET_REVISION" ("ID" CHAR(36) NOT NULL PRIMARY KEY, "REVIEW_TASK_ID" CHAR(36) NOT NULL, "CHANGESET_REVISION" NUMBER(11) NOT NULL, "SNAPSHOT_ID" VARCHAR2(36) NOT NULL, "FILE_UUID" VARCHAR2(36) NOT NULL, "DOCUMENT_INCARNATION" VARCHAR2(36) NOT NULL, "EXACT_SDOC_VERSION" NUMBER(19) NOT NULL, "PROJECTION_VERSION" VARCHAR2(64) NOT NULL, "SCOPE_SUMMARY" CLOB NOT NULL, "REVISION_BRIEF" CLOB NOT NULL, "CREATED_AT" TIMESTAMP(6) NOT NULL, CONSTRAINT "AI_REV_CS_TASK_REV" UNIQUE ("REVIEW_TASK_ID", "CHANGESET_REVISION"));
CREATE INDEX "AI_REV_CS_FILE" ON "AI_REVIEW_CHANGESET_REVISION" ("FILE_UUID");
CREATE TABLE "AI_REVIEW_GENERATION_CHUNK" ("ID" CHAR(36) NOT NULL PRIMARY KEY, "REVIEW_TASK_ID" CHAR(36) NOT NULL, "GENERATION_ATTEMPT_ID" CHAR(36) NOT NULL, "CHUNK_INDEX" NUMBER(11) NOT NULL, "BLOCK_COUNT" NUMBER(11) NOT NULL, "CREATED_ITEM_COUNT" NUMBER(11) NOT NULL, "CREATED_AT" TIMESTAMP(6) NOT NULL, CONSTRAINT "AI_REV_CHUNK_ATTEMPT_INDEX" UNIQUE ("REVIEW_TASK_ID", "GENERATION_ATTEMPT_ID", "CHUNK_INDEX"));
CREATE TABLE "AI_REVIEW_CHANGE_ITEM" ("ID" CHAR(36) NOT NULL PRIMARY KEY, "ITEM_ID" CHAR(36) NOT NULL, "CHANGESET_REVISION_ID" CHAR(36) NOT NULL, "LOGICAL_ITEM_ID" CHAR(36) NULL, "TARGET_KEY" VARCHAR2(160) NULL, "KIND" VARCHAR2(64) NOT NULL, "TARGET" CLOB NOT NULL, "PRECONDITION" CLOB NOT NULL, "PREVIEW" CLOB NOT NULL, "AFTER_TEXT" CLOB NOT NULL, "AFTER_TYPE" VARCHAR2(64) NULL, "RATIONALE" CLOB NOT NULL, "SORT_ORDER" NUMBER(11) NOT NULL, "CREATED_AT" TIMESTAMP(6) NOT NULL, CONSTRAINT "AI_REV_ITEM_REV_ITEM" UNIQUE ("CHANGESET_REVISION_ID", "ITEM_ID"), CONSTRAINT "AI_REV_ITEM_REV_TARGET" UNIQUE ("CHANGESET_REVISION_ID", "TARGET_KEY"));
CREATE INDEX "AI_REV_ITEM_ITEM" ON "AI_REVIEW_CHANGE_ITEM" ("ITEM_ID");
CREATE INDEX "AI_REV_ITEM_LOGICAL" ON "AI_REVIEW_CHANGE_ITEM" ("LOGICAL_ITEM_ID");
CREATE TABLE "AI_REVIEW_CARD_REVISION" ("ID" CHAR(36) NOT NULL PRIMARY KEY, "REVIEW_TASK_ID" CHAR(36) NOT NULL, "CHANGESET_REVISION_ID" CHAR(36) NOT NULL, "CARD_REVISION" NUMBER(11) NOT NULL, "SUPERSEDES_DECISION_ID" CHAR(36) NULL, "CREATED_AT" TIMESTAMP(6) NOT NULL, CONSTRAINT "AI_REV_CARD_TASK_REV" UNIQUE ("REVIEW_TASK_ID", "CARD_REVISION"));
CREATE INDEX "AI_REV_CARD_CHANGESET" ON "AI_REVIEW_CARD_REVISION" ("CHANGESET_REVISION_ID");
CREATE TABLE "AI_REVIEW_CARD_REVISION_ITEM" ("ID" CHAR(36) NOT NULL PRIMARY KEY, "CARD_REVISION_ITEM_ID" CHAR(36) NOT NULL, "CARD_REVISION_ID" CHAR(36) NOT NULL, "CHANGE_ITEM_ID" CHAR(36) NOT NULL, "REVIEWABLE" NUMBER(1) NOT NULL, "CONFLICTED" NUMBER(1) NOT NULL, "SELECTABLE" NUMBER(1) NOT NULL, "CONFLICT_SUMMARY" CLOB NULL, "CREATED_AT" TIMESTAMP(6) NOT NULL, CONSTRAINT "AI_REV_CARD_ITEM_UNIQ" UNIQUE ("CARD_REVISION_ID", "CHANGE_ITEM_ID"));
CREATE INDEX "AI_REV_CARD_ITEM_ID" ON "AI_REVIEW_CARD_REVISION_ITEM" ("CARD_REVISION_ITEM_ID");
CREATE INDEX "AI_REV_CARD_CHANGE_ID" ON "AI_REVIEW_CARD_REVISION_ITEM" ("CHANGE_ITEM_ID");
CREATE TABLE "AI_REVIEW_DECISION" ("ID" CHAR(36) NOT NULL PRIMARY KEY, "REVIEW_DECISION_ID" CHAR(36) NOT NULL UNIQUE, "CARD_REVISION_ID" CHAR(36) NOT NULL, "DECISION_KIND" VARCHAR2(16) NOT NULL, "SELECTION_DIGEST" VARCHAR2(64) NOT NULL, "OPERATOR" VARCHAR2(255) NOT NULL, "CREATED_AT" TIMESTAMP(6) NOT NULL);
CREATE INDEX "AI_REV_DEC_CARD" ON "AI_REVIEW_DECISION" ("CARD_REVISION_ID");
CREATE TABLE "AI_REVIEW_DECISION_SELECTION" ("ID" CHAR(36) NOT NULL PRIMARY KEY, "DECISION_ID" CHAR(36) NOT NULL, "CARD_REVISION_ITEM_ID" CHAR(36) NOT NULL, CONSTRAINT "AI_REV_DEC_SEL_UNIQ" UNIQUE ("DECISION_ID", "CARD_REVISION_ITEM_ID"));
CREATE INDEX "AI_REV_DEC_SEL_CARD" ON "AI_REVIEW_DECISION_SELECTION" ("CARD_REVISION_ITEM_ID");
CREATE TABLE "AI_REVIEW_APPLY_ATTEMPT" ("ID" CHAR(36) NOT NULL PRIMARY KEY, "APPLY_ATTEMPT_ID" CHAR(36) NOT NULL UNIQUE, "REVIEW_DECISION_ID" CHAR(36) NOT NULL UNIQUE, "STATUS" VARCHAR2(32) NOT NULL, "PERSISTENCE_STATUS" VARCHAR2(32) NOT NULL, "VERIFICATION_STATUS" VARCHAR2(32) NOT NULL, "APPROVED_BY" VARCHAR2(255) NOT NULL, "SELECTION_DIGEST" VARCHAR2(64) NOT NULL, "APPLY_PAYLOAD_DIGEST" VARCHAR2(64) NOT NULL, "CARD_REVISION_NUMBER" NUMBER(11) NOT NULL, "CHANGESET_REVISION_NUMBER" NUMBER(11) NOT NULL, "SNAPSHOT_ID" VARCHAR2(36) NOT NULL, "DOCUMENT_INCARNATION" VARCHAR2(36) NOT NULL, "APPLIED_SDOC_VERSION" NUMBER(19) NULL, "OPERATION_LOG_CORRELATION_ID" VARCHAR2(36) NULL, "RESULT_QUERY_DEADLINE_AT" TIMESTAMP(6) NULL, "ERROR_CODE" VARCHAR2(64) NULL, "CREATED_AT" TIMESTAMP(6) NOT NULL, "UPDATED_AT" TIMESTAMP(6) NOT NULL);
CREATE INDEX "AI_REV_APPLY_STATUS" ON "AI_REVIEW_APPLY_ATTEMPT" ("STATUS");
