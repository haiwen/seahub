...
CREATE TABLE "AI_REVIEW_CHANGE_ITEM" ("ID" CHAR(36) NOT NULL PRIMARY KEY, "ITEM_ID" CHAR(36) NOT NULL, "CHANGESET_REVISION_ID" CHAR(36) NOT NULL, "LOGICAL_ITEM_ID" CHAR(36) NULL, "KIND" VARCHAR2(64) NOT NULL, "TARGET" CLOB NOT NULL, "PRECONDITION" CLOB NOT NULL, "PREVIEW" CLOB NOT NULL, "AFTER_TEXT" CLOB NOT NULL, "AFTER_TYPE" VARCHAR2(64) NULL, "RATIONALE" CLOB NOT NULL, "SORT_ORDER" NUMBER(11) NOT NULL, "CREATED_AT" TIMESTAMP(6) NOT NULL, CONSTRAINT "AI_REV_ITEM_REV_ITEM" UNIQUE ("CHANGESET_REVISION_ID", "ITEM_ID"));
