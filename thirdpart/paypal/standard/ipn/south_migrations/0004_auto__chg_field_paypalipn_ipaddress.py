...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('paypal_ipn', 'ipaddress', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True))

    def backwards(self, orm):

        # Changing field 'PayPalIPN.ipaddress'
        db.alter_column('paypal_ipn', 'ipaddress', self.gf('django.db.models.fields.IPAddressField')(default='', max_length=15))
