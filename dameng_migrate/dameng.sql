...
CREATE TABLE IF NOT EXISTS "AVATAR_UPLOADED" ("FILENAME" TEXT NOT NULL, "FILENAME_MD5" CHAR(32) NOT NULL PRIMARY KEY, "DATA" CLOB NOT NULL, "SIZE" INTEGER NOT NULL, "MTIME" DATETIME NOT NULL);
