...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Enter the new file name:": "Ingrese el nuevo nombre de archivo:", 
    "Enter the new folder name:": "Ingrese el nuevo nombre de carpeta:", 
    "Error": "Error", 
    "Expired": "Expirado", 
    ...
    "Maximum number of files exceeded": "N\u00famero m\u00e1ximpo de archivos excedido", 
    ...
    "Please click and choose a directory.": "Por favor, selecciona una carpeta con un click.", 
    ...
    "Renamed or Moved files": "Archivos renombrados o movidos", 
    "Replace file {filename}?": "\u00bfReemplazar archivo {filename}?", 
    "Restore Library": "Restaurar biblioteca", 
    "Saving...": "Guardando...", 
    "Search files in this wiki": "Buscar archivos en el wiki", 
    ...
    "Successfully deleted 1 item.": "1 item eliminado con \u00e9xito", 
