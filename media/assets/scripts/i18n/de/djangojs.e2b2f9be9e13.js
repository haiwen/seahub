...
(function (globals) {
  ...
  django.catalog = {
    ...
    "Rename Directory": "Ordner umbenennen", 
    "Rename File": "Datei umbenennen", 
    "Replace file {filename}?": "Datei {filename} austauschen?", 
    "Saving...": "Speichere ...", 
    "Search users or enter emails": "Benutzer/in suchen oder E-Mail-Adresse eingeben", 
    "Select groups": "Gruppen ausw\u00e4hlen", 
    "Set {placeholder}'s permission": "Rechte von {placeholder} festlegen", 
    "Share failed": "Freigeben fehlgeschlagen", 
    ...
    "You have not renamed it.": "Nicht umbenannt. ", 
    "canceled": "abgebrochen", 
