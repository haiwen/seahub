...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Allow user to add organization libraries. Otherwise, only system admin can add organization libraries.": "Benutzer k\u00f6nnen \u00f6ffentliche Bibliotheken anlegen. (Wenn dies nicht aktiviert ist, k\u00f6nnen \u00f6ffentliche Bibliotheken nur mit Adminrechten angelegt werden.)",
