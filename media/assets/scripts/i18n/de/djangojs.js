...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Add Admins": "Administratoren hinzuf\u00fcgen",
    ...
    "Add child tags": "Untergeordnete Tags hinzuf\u00fcgen",
    ...
    "Advanced": "Erweitert",
    "After enable OCR, you can extract text from images or scanned PDFs.": "Texterkennung (OCR) extrahiert Text aus Bildern oder gescannten PDFs.",
    ...
    "Do you really want to turn off OCR? Existing OCR results will be deleted.": "M\u00f6chten Sie die Texterkennung (OCR) wirklich deaktivieren? Alle OCR-Ergebnisse werden gel\u00f6scht.",
    ...
    "Emojis": "Emojis",
    "Empty": "Leer",
    "Enable OCR": "Texterkennung (OCR) aktivieren",
    "Enable Two-Factor Authentication": "Zwei-Faktor-Authentifizierung aktivieren",
    "Enable branding CSS": "Custom CSS verwenden",
    ...
    "Extracting text by AI...": "Der Text wird durch KI extrahiert ...",
    ...
    "Group has been transfered": "Die Gruppe wurde \u00fcbertragen",
    ...
    "No address found for the given coordinates.": "F\u00fcr die Koordinaten wurde keine Adresse gefunden.",
    ...
    "Predefined properties": "Vordefinierte Eigenschaften",
    ...
    "Search property types": "Eigenschaftstypen suchen",
    ...
    "Select a office suite": "Office Suite ausw\u00e4hlen",
    ...
    "Successfully change office suite.": "Die Office Suite wurde ge\u00e4ndert.",
    ...
    "Tags language:": "Tag-Sprache",
    "Team name": "Teamname",
    "Template": "Template",
    "Terms": "Nutzungsbedingungen",
    "Terms and Conditions": "Nutzungsvereinbarungen",
    "Text": "Text",
    "Text extracted": "Der Text wurde extrahiert.",
    ...
    "The imported tag already exists": "Das importierte Tag ist bereits vorhanden.",
    ...
    "Turn off OCR": "Texterkennung (OCR) deaktiveren",
    ...
    "You can add a Wiki by clicking the \"Add Wiki\" item in the dropdown menu.": "Sie k\u00f6nnen ein neues Wiki anlegen, indem Sie im Dropdown-Men\u00fc auf \"Wiki hinzuf\u00fcgen\" klicken.",
    ...
    "You do not have any Wikis yet.": "Sie haben noch kein Wikis.",
