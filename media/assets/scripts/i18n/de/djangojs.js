...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Allow user to add organization libraries. Otherwise, only system admin can add organization libraries.": "Benutzer/innen k\u00f6nnen \u00f6ffentliche Bibliotheken anlegen. (Wenn dies nicht aktiviert ist, k\u00f6nnen \u00f6ffentliche Bibliotheken nur mit Adminrechten angelegt werden.)",
    ...
    "Successfully revoked the admin permission of {placeholder}.": "{placeholder} wurden die Adminrechte entzogen.",
    ...
    "The least number of characters a download/upload link password should include.": "Mindestzahl von Zeichen f\u00fcr Passw\u00f6rter von Freigabe-Links.",
    ...
    "{userCount} user(s) and {repoCount} libraries of this organization will also be deleted.": "{userCount} Benutzer/innen und {repoCount} Bibliotheken dieser Organisation werden hiermit ebenfalls gel\u00f6scht.",
