...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Anonymous User": "Benutzer/in anonym", 
    ...
    "Count": "Zugriffe", 
    "Create At / Last Login": "Erstellungsdatum /\nLetzte Anmeldung", 
    ...
    "Folder": "Ordner", 
    "Folder Permission": "Ordnerrechte", 
    "Folder Premission": "Ordnerrechte", 
    ...
    "Groups allow multiple people to collaborate on libraries. You can create a group by clicking the \"New Group\" button.": "Bisher sind Sie noch keiner Gruppe hinzugef\u00fcgt worden und haben damit keinen Zugriff auf Gruppenbibliotheken. Sie k\u00f6nnen eine Gruppe erstellen, indem Sie auf die Schaltfl\u00e4che \"Neue Gruppe\" klicken.", 
    "Help": "Hilfe", 
    "Hide": "Verbergen", 
    "History": "Versionen", 
    ...
    "No deleted libraries.": "Sie haben keine gel\u00f6schten Bibliotheken.", 
    "No departments": "Keine Bereiche vorhanden", 
    "No draft yet": "Noch kein Entwurf vorhanden", 
    "No libraries": "Keine Bibliotheken", 
    "No libraries have been shared directly with you. You can find more shared libraries at \"Shared with groups\".": "Bisher hat noch niemand eine Bibliothek direkt f\u00fcr Sie freigegeben. Freigaben sind mit vollen oder eingeschr\u00e4nkten Rechten m\u00f6glich. Wenn Sie Zugriff auf eine Bibliothek ben\u00f6tigen, die jemand anderem geh\u00f6rt, bitten Sie die Person sie f\u00fcr Sie freizugeben.", 
    "No libraries have been shared with you": "Sie haben keinen Zugriff auf Bibliotheken anderer Benutzer.", 
    "No library is shared to this group": "Es gibt keine an diese Gruppe freigegebene Bibliotheken.", 
    ...
    "Public": "\u00d6ffentlich", 
    "Public libraries are for publishing your contents in an organized way.": "Bisher haben Sie noch keine Bibliothek ver\u00f6ffentlicht. Auf eine ver\u00f6ffentlichte Bibliothek hat jeder \u00fcber die URL der ver\u00f6ffentlichten Bibliothek Zugriff, nicht nur Benutzer. Sie k\u00f6nnen eine Bibliothek ver\u00f6ffentlichen, indem Sie auf die Schaltfl\u00e4che \"Bibliothek ver\u00f6ffentlichen\" klicken.", 
    ...
    "Set user contact email": "E-Mail-Adresse f\u00fcr Benutzer/in setzen", 
    "Set user name": "Name f\u00fcr Benutzer/in setzen", 
    ...
    "Tip: libraries deleted 30 days ago will be cleaned automatically.": "Hinweis: Gel\u00f6schte Bibliotheken werden 30 Tage nach ihrer L\u00f6schung automatisch vollst\u00e4ndig aus dem System entfernt.", 
    "Tools": "Werkzeuge", 
    ...
    "Used:": "Verwendet:", 
    "User": "Benutzer", 
    "User Permission": "Benutzerrechte", 
    ...
    "You can create a library to organize your files. For example, you can create one for each of your projects. Each library can be synchronized and shared separately.": "Bisher haben Sie noch keine eigene Bibliothek erstellt. Eine Bibliothek ist ein Container, in dem Sie Ihre Dateien und Ordner organisieren k\u00f6nnen. Eine Bibliothek l\u00e4sst sich auch an andere Benutzer freigeben und auf verbundene Ger\u00e4te synchronisieren. Sie k\u00f6nnen eine Bibliothek erstellen, indem Sie auf die Schaltfl\u00e4che \"Neue Bibliothek\" klicken.", 
    "You can create a public library by clicking the \"New Library\" button, others can view and download this library.": "Bisher wurde noch keine \u00f6ffentliche Bibliothek erstellt. Auf eine \u00f6ffentliche Bibliothek hat jeder Benutzer Zugriff. Sie k\u00f6nnen eine \u00f6ffentliche Bibliothek erstellen, indem Sie auf die Schaltfl\u00e4che \"Bibliothek hinzuf\u00fcgen\" klicken.", 
    ...
    "You can generate a share link for a folder or a file. Anyone who receives this link can view the folder or the file online.": "Bisher haben Sie keine Download-Links erstellt. Mit Download-Links k\u00f6nnen Sie Dateien und Ordner mit anderen Personen, nicht nur anderen Benutzern, austauschen. Sie k\u00f6nnen einen Download-Link f\u00fcr eine Datei oder Ordner erstellen, indem Sie auf das Teilen-Icon rechts neben dem Datei- bzw. Ordnernamen klicken.", 
    "You can generate an upload link from any folder. Anyone who receives this link can upload files to this folder.": "Bisher haben Sie keine Upload-Links erstellt. \u00dcber einen Upload-Link k\u00f6nnen andere Personen, nicht nur andere Benutzer, Dateien in Order oder Bibliotheken hochladen. Sie k\u00f6nnen einen Upload-Link f\u00fcr einen Ordner oder eine Bibliothek erstellen, indem Sie auf das Teilen-Icon rechts neben dem Datei- bzw. Ordnernamen klicken.", 
    "You can only select 1 item": "Sie k\u00f6nnen nur 1 Objekt ausw\u00e4hlen", 
    "You can share a single folder with a registered user if you don't want to share a whole library.": "Bisher haben Sie keine Ordner an andere Benutzer freigegeben. Sie k\u00f6nnen einen Ordner an andere Benutzer freigeben, indem Sie in \"Meine Bibliotheken\" auf das Teilen-Icon rechts des Ordnernamens klicken.", 
    "You can share libraries by clicking the \"New Library\" button above or the \"Share\" icon on your libraries list.": "Bisher wurden noch keine Bibliotheken an diese Gruppe freigegeben. Jedes Gruppenmitglied kann auf eine Bibliothek zugreifen, die an die Gruppe freigegeben wurde. Sie k\u00f6nnen eine Bibliothek an eine Gruppe freigeben, indem Sie in \"Meine Bibliotheken\" auf das Teilen-Icon rechts des Bibliotheksnamens klicken. Sie k\u00f6nnen auch eine neue eigene Bibliothek anlegen, die unmittelbar an diese Gruppe freigegeben wird, indem Sie auf die Schaltfl\u00e4che \"Neue Bibliothek\" klicken.", 
    "You can share libraries with your friends and colleagues by clicking the share icon of your own libraries in your home page or creating a new library in groups you are in.": "Bisher haben Sie keine Bibliotheken an andere Benutzer freigegeben. Sie k\u00f6nnen eine Bibliothek an andere Benutzer freigeben, indem Sie in \"Meine Bibliotheken\" auf  das Teilen-Icon rechts des Bibliotheksnamens klicken.", 
    ...
    "You do not have any public library": "Sie haben keine Bibliotheken ver\u00f6ffentlicht.", 
    "You do not have connected devices": "Sie haben keine Ger\u00e4te mit Ihrem Benutzerkonto verbunden.", 
    ...
    "You have not created any libraries": "Sie haben noch keine eigenen Bibliotheken.", 
    "You have not invited any people.": "Sie haben keine G\u00e4ste eingeladen.", 
    ...
    "Your clients (Desktop/Android/iOS) will be listed here.": "Bisher haben Sie noch mit keinem Client (Desktop oder Mobil) auf Ihre Dateien zugegriffen. Richten Sie auf Ihren Ger\u00e4ten Clients ein, um bequemer auf die Dateien zuzugreifen.", 
