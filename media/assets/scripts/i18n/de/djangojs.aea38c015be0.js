...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "AI": "KI",
    "AI Chat and Search": "KI-Chat und Suche",
    "AI Usage": "KI-Nutzung",
    "AI credit used this month": "In diesem Monat verbrauchte KI-Credits",
    "AI credit used:": "Verbrauchte KI-Credits:",
    "AI server not configured": "KI-Server nicht konfiguriert",
    "AI summary": "KI-Zusammenfassung",
    "AI summary time": "Zeit der KI-Zusammenfassung",
    "AI usage details": "Details zur KI-Nutzung",
    "API Token": "API-Token",
    ...
    "Advanced": "Erweitert",
    "After": "Danach",
    "After connecting libraries, you can list files from them in the Wiki pages.": "Nach dem Verbinden von Bibliotheken k\u00f6nnen Sie Dateien daraus in den Wiki-Seiten auflisten.",
    ...
    "All comments ({comments_count})": "Alle Kommentare ({comments_count})",
    ...
    "An integer that is greater than 0.": "Eine Ganzzahl, die gr\u00f6\u00dfer als 0 ist.",
    ...
    "Are you sure you want to delete all unhandled infected files across all pages?": "M\u00f6chten Sie wirklich alle unbearbeiteten infizierten Dateien auf allen Seiten l\u00f6schen?",
    ...
    "Are you sure you want to delete this webhook?": "M\u00f6chten Sie diesen Webhook wirklich l\u00f6schen?",
    ...
    "Are you sure you want to ignore all unhandled infected files across all pages?": "M\u00f6chten Sie wirklich alle unbearbeiteten infizierten Dateien auf allen Seiten ignorieren?",
    ...
    "Ask anything about your files": "Fragen Sie alles zu Ihren Dateien",
    "At server": "Server",
    "Attachments": "Anh\u00e4nge",
    "Audio": "Audio",
    ...
    "Chat": "Chat",
    "Chat name": "Chatname",
    "Chat shared": "Chat freigegeben",
    "Chat unshared": "Chat nicht mehr freigegeben",
    ...
    "Close metadata": "Metadaten schlie\u00dfen",
    ...
    "Common icons": "Allgemeine Symbole",
    ...
    "Connect": "Verbinden",
    "Connected libraries": "Verkn\u00fcpfte Bibliotheken",
    ...
    "Count": "Zugriffe",
    "Cover": "Deckblatt",
    "Cover photo has been set": "Titelfoto wurde festgelegt",
    "Create": "Erstellen",
    ...
    "Created Folders": "Erstellte Ordner",
    ...
    "Created {n} folders": "{n} Ordner erstellt",
    "Creator": "Eigent\u00fcmer",
    "Credit not enough": "Nicht gen\u00fcgend Guthaben",
    "Credit used": "Verbrauchtes Guthaben",
    ...
    "Delete all unhandled files": "Alle unbearbeiteten Dateien l\u00f6schen",
    ...
    "Deleted Folders": "Gel\u00f6schte Ordner",
    ...
    "Deleted {n} {type}": "{n} {type} gel\u00f6scht",
    "Department": "Bereich",
    ...
    "Design & geometry icons": "Symbole f\u00fcr Design und Geometrie",
    "Desktop": "Desktop",
    ...
    "Do you really want to turn off AI Chat and Search? AI chat and file search will no longer be available, and existing AI summaries will all be deleted.": "M\u00f6chten Sie KI-Chat und Suche wirklich deaktivieren? KI-Chat und Dateisuche stehen dann nicht mehr zur Verf\u00fcgung, und alle vorhandenen KI-Zusammenfassungen werden gel\u00f6scht.",
    ...
    "Emojis": "Emojis",
    "Empty": "Leer",
    "Enable AI chat and AI search on your files. Your files will be summarized to enable AI to efficiently find your files during chat.": "Aktivieren Sie KI-Chat und KI-Suche f\u00fcr Ihre Dateien. Ihre Dateien werden zusammengefasst, damit die KI Ihre Dateien w\u00e4hrend des Chats effizient finden kann.",
    ...
    "Entertainment & games icons": "Symbole f\u00fcr Unterhaltung und Spiele",
    "Error": "Fehler",
    ...
    "Extended properties are being built.": "Die erweiterten Eigenschaften werden aufgebaut.",
    ...
    "Failed to copy %(name)s.": "Fehler beim Kopieren von %(name)s.",
    "Failed to copy QR code": "QR-Code konnte nicht kopiert werden",
    ...
    "File type": "Dateityp",
    "File {file_link} has a new comment from user {author}.": "Die Datei {file_link} hat einen neuen Kommentar von Benutzer {author}.",
    "Files": "Dateien",
    ...
    "Format": "Format",
    "Found %1$d references": "%1$d Referenzen gefunden",
    "Found 1 reference": "1 Referenz gefunden",
    ...
    "Icons": "Symbole",
    "Icons auto-matched by name {custom}": "Symbole werden automatisch anhand des Namens {custom} zugeordnet",
    ...
    "Ignore all unhandled files": "Alle unbearbeiteten Dateien ignorieren",
    "Ignored": "Ignoriert",
    "Image saved": "Das Bild wurde gespeichert.",
    "Images wider than 1500 pixels work best.": "Bilder mit einer Breite von mehr als 1500 Pixeln eignen sich am besten.",
    "Import": "Import",
    ...
    "Inactive": "Inaktiv",
    "Infected File": "Infizierte Datei",
    "Info": "Info",
    "Input name, AI matches icons automatically {custom}": "Name eingeben, KI ordnet Symbole automatisch zu {custom}",
    "Input tokens": "Eingabetokens",
    ...
    "Last month same day": "Letzter Monat, gleicher Tag",
    "Leave": "Verlassen",
    ...
    "Manage Published Pages": "Ver\u00f6ffentlichte Seiten verwalten",
    ...
    "Medical & health icons": "Symbole f\u00fcr Medizin und Gesundheit",
    "Megaphone Icon": "Megafon-Symbol",
    "Member": "Mitglied",
    "Members": "Mitglieder",
    ...
    "Month": "Monat",
    "Month on month change": "Monat-zu-Monat-\u00c4nderung",
    "Month:": "Monat:",
    "Monthly Traffic Limit": "Monatliches Traffic-Limit",
    ...
    "Nature & science icons": "Symbole f\u00fcr Natur und Wissenschaft",
    ...
    "No shared chats": "Keine freigegebenen Chats",
    ...
    "No suggested icons found. Add icons with {custom}": "Keine vorgeschlagenen Symbole gefunden. F\u00fcge Symbole mit {custom} hinzu",
    ...
    "Note, the library must turn on extended properties feature to be connected to a Wiki.": "Hinweis: Die Bibliothek muss die Funktion f\u00fcr erweiterte Eigenschaften aktivieren, um mit einem Wiki verbunden werden zu k\u00f6nnen.",
    ...
    "Objects & daily life icons": "Symbole f\u00fcr Objekte und Alltag",
    ...
    "Only show groups with libraries": "Nur Gruppen mit Bibliotheken anzeigen",
    ...
    "Open metadata": "Metadaten \u00f6ffnen",
    "Open parent folder": "\u00dcbergeordneten Ordner \u00f6ffnen",
    "Open the panel": "Leiste anzeigen",
    "Open with": "\u00d6ffnen mit",
    "Open with OnlyOffice": "Mit OnlyOffice \u00f6ffnen",
    "Open with client": "Mit Client \u00f6ffnen",
    "Operation": "Aktion",
    ...
    "Pre-render published wiki pages on the server so search engines can index their content more reliably.": "Ver\u00f6ffentlichte Wiki-Seiten auf dem Server vorab rendern, damit Suchmaschinen ihren Inhalt zuverl\u00e4ssiger indexieren k\u00f6nnen.",
    ...
    "Rate": "Rating",
    "Raw": "Roh",
    "Raw file link": "Rohdateilink",
    "Raw file link is copied to the clipboard.": "Der Rohdateilink wurde in die Zwischenablage kopiert.",
    "Read-Only": "Nur Lesen",
    ...
    "Restore items": "Elemente wiederherstellen",
    ...
    "Restored {n} items": "{n} Elemente wiederhergestellt",
    ...
    "SEO: Pre-render published pages": "SEO: Ver\u00f6ffentlichte Seiten vorab rendern",
    "SSO": "SSO",
    "Satellite": "Satellit",
    "Save": "Speichern",
    ...
    "Search users": "Benutzer suchen",
    "Search users...": "Benutzer suchen \u2026",
    "Search wiki pages": "Wiki-Seiten suchen",
    "Search wikis": "Wikis suchen",
    "Searching...": "Suche \u2026",
    "Secret": "Geheimnis",
    "Select": "Ausw\u00e4hlen",
    ...
    "Send password separately": "Passwort separat senden",
    "Send to:": "Senden an:",
    ...
    "Start a new chat from this conversation": "Neuen Chat aus dieser Unterhaltung starten",
    "Start date": "Startdatum",
    "Started a new chat from this conversation": "Neuer Chat aus dieser Unterhaltung gestartet",
    "Statistic": "Statistik",
    ...
    "Successfully deleted {count} items.": "{count} Elemente erfolgreich gel\u00f6scht.",
    ...
    "Successfully ignored {count} items.": "{count} Elemente erfolgreich ignoriert.",
    ...
    "Successfully set monthly traffic limit.": "Monatliches Traffic-Limit erfolgreich festgelegt.",
    ...
    "Successfully starred {name_placeholder}": "{name_placeholder} erfolgreich zu den Favoriten hinzugef\u00fcgt",
    ...
    "Successfully transferred the wiki.": "Das Wiki wurde erfolgreich \u00fcbertragen.",
    ...
    "Successfully unstarred {name_placeholder}": "{name_placeholder} erfolgreich aus den Favoriten entfernt",
    ...
    "Suggested icons": "Vorgeschlagene Symbole",
    ...
    "System": "System",
    "System & devices icons": "Symbole f\u00fcr System und Ger\u00e4te",
    ...
    "The content has been copied": "Der Inhalt wurde kopiert",
    ...
    "The number of metadata records exceeds the limit of {mdFileCountLimit} files.": "Die Anzahl der Metadatens\u00e4tze \u00fcberschreitet das Limit von {mdFileCountLimit} Dateien.",
    ...
    "This library has been archived, cannot be updated.": "Diese Bibliothek wurde archiviert und kann nicht aktualisiert werden.",
    ...
    "Tip: a snapshot will be generated after modification, which records the library state after the modification": "Tipp: Nach der \u00c4nderung wird ein Snapshot erstellt, der den Bibliotheksstatus nach der \u00c4nderung festh\u00e4lt",
    ...
    "Toggle department group menu": "Abteilungsgruppenmen\u00fc umschalten",
    ...
    "Transport & location icons": "Symbole f\u00fcr Transport und Ort",
    "Trash": "Papierkorb",
    "Triple": "Dreifach",
    "Turn off": "Deaktivieren",
    "Turn off AI Chat and Search": "KI-Chat und Suche deaktivieren",
    ...
    "URL should start with http(s).": "Die URL sollte mit http(s) beginnen.",
    "US": "Amerikanisch",
    ...
    "Unwatch all": "Alle nicht mehr verfolgen",
    "Up": "Aufsteigend",
    ...
    "View snapshot": "Snapshot anzeigen",
    "Views": "Ansichten",
    "Virus": "Virus",
    ...
    "When you set a secret, you will receive the X-Seafile-Signature header in the webhook POST request, which is the SHA256 encryption result of the secret and request.body.": "Wenn Sie ein Geheimnis festlegen, erhalten Sie im Webhook-POST-Request den Header X-Seafile-Signature, der das SHA256-Verschl\u00fcsselungsergebnis aus dem Geheimnis und request.body ist.",
    ...
    "Wiki unpublished": "Wiki nicht ver\u00f6ffentlicht",
    "Wikis": "Wikis",
    ...
    "You do not have permission to access Trash.": "Sie haben keine Berechtigung, auf den Papierkorb zuzugreifen.",
    ...
    "{folder} and {n} other folders": "{folder} und {n} weitere Ordner",
    ...
    "{name} and {n} other files": "{name} und {n} weitere Dateien",
    "{name} and {n} other folders": "{name} und {n} weitere Ordner",
    ...
    "{user} renamed file {oldFileName} to {fileName} in library {libraryName}.": "{user} hat die Datei {oldFileName} in der Bibliothek {libraryName} in {fileName} umbenannt.",
    "{user} renamed folder {oldFolderName} to {folderName} in library {libraryName}.": "{user} hat den Ordner {oldFolderName} in der Bibliothek {libraryName} in {folderName} umbenannt.",
