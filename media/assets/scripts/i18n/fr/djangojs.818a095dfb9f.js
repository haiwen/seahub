...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "(at least {passwordLength} characters and has {shareLinkPasswordStrengthLevel} of the following: num, upper letter, lower letter and other symbols)": "(au moins {passwordLength} caract\u00e8res et au moins contenir {shareLinkPasswordStrengthLevel} des \u00e9l\u00e9ments suivants : chiffres, majuscules, minuscules et autres symboles)",
    ...
    "Modify": "Modifier",
    "Modify includes modify file, create file and folder, move/rename file and folder": "Modifier inclut la modification de fichier, la cr\u00e9ation de fichier et dossier, le d\u00e9placement ou renommage de fichier et dossier",
    "Month:": "Mois :",
    ...
    "Password is too weak, should have at least {shareLinkPasswordStrengthLevel} of the following: num, upper letter, lower letter and other symbols": "Le mot de passe est trop faible, il devrait contenir au moins {shareLinkPasswordStrengthLevel} des \u00e9l\u00e9ments suivants : chiffres, majuscules, minuscules et autres symboles",
    "Password:": "Mot de passe :",
