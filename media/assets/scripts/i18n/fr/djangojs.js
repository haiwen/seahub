...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Enter comment, Shift + Enter for new line, Enter to send": "Entrez un commentaire (ins\u00e9rez un retour \u00e0 la ligne avec MAJ + ENTREE ; envoyez le commentaire avec ENTREE)",
    "Enter reply, Shift + Enter for new line, Enter to send": "Entrez une r\u00e9ponse (ins\u00e9rez un retour \u00e0 la ligne avec MAJ + ENTREE ; envoyez le commentaire avec ENTREE)",
    "Error": "Erreur",
    "Errors": "Erreurs",
    "European": "Europ\u00e9en",
