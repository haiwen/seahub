...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Ask for review": "Richiedi una revisione", 
    "Author": "Autore", 
    "Avatar": "Avatar", 
    "Back": "Indietro", 
    ...
    "Close review": "Chiudi revisione", 
    "Closed": "Chiuso", 
    "Co-Owner": "Co-Proprietrio", 
    "Comment": "Commento", 
    "Contents": "Contenuti", 
    "Copy": "Copia", 
    "Copy internal link": "Copia il link interno", 
    ...
    "Expired": "Scaduto", 
    "Failed to close review %(reviewID)s": "Impossibile chiudere la recensione %(reviewID)s", 
    ...
    "Failed to publish draft.": "Impossibile pubblicare bozza.", 
    ...
    "Markdown Document": "Documento di tipo Markdown", 
    ...
    "No related file yet.": "Ancora Nessun file correlato.", 
    ...
    "Review": "Revisione", 
    "Review already exists.": "Revisione gi\u00e0 presente.", 
    ...
    "Successfully closed review %(reviewID)s.": "Recensione chiusa con successo %(reviewID)s.", 
    ...
    "Successfully published draft.": "Bozza pubblicata con successo.", 
    ...
    "The review has been closed.": "La recensione \u00e8 stata chiusa.", 
    "This file is in draft stage.": "Questo file \u00e8 in fase di bozza.", 
    "This file is in review stage": "Questo file \u00e8 in fase di revisione", 
    ...
    "View Review": "Visualizza recensione", 
    ...
    "You can create online document using Markdown format easily. When creating a document, you can mark it as draft. After finishing the draft, you can ask others to review it. They can view the document history in the review page and leave comments on the document.": "\u00c8 possibile creare facilmente un documento online utilizzando il formato Markdown. Quando crei un documento, puoi contrassegnarlo come bozza. Dopo aver completato la bozza, puoi chiedere ad altri di esaminarla. Possono visualizzare la cronologia del documento nella pagina di revisione e lasciare commenti sul documento.", 
