...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "A file named {upload_file_link} is uploaded to {uploaded_link}.": "Un file chiamato {upload_file_link} viene caricato su {uploaded_link}.",
    "A file named {upload_file_link} is uploaded.": "Un file chiamato {upload_file_link} viene caricato.",
    "A file with the same name already exists in this folder.": "Un file con lo stesso nome esiste gi\u00e0 in questa cartella.",
    "A folder named {upload_folder_link} is uploaded to {uploaded_link}.": "Una cartella chiamata {upload_folder_link} viene caricata su {uploaded_link}.",
    "A folder named {upload_folder_link} is uploaded.": "Viene caricata una cartella chiamata {upload_folder_link}.",
    "AI": "AI",
    ...
    "Mark notification as read": "Marca la notifica come letta",
    ...
    "Select members from department": "Seleziona membri dal dipartimento",
    ...
    "Toggle department group menu": "Apri/Chiudi menu gruppo departamento",
    ...
    "View notification": "Visualizza la notifica",
