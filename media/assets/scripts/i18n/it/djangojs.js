...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "1 preset filter": "1 filtro preimpostato",
    "1 preset hidden property": "1 propriet\u00e0 nascosta preimpostata",
    "1 preset sort": "1 ordinamento preimpostato",
    ...
    "Add SeaTable Integration": "Aggiungi l'integrazione SeaTable",
    ...
    "Are you sure you want to delete SeaTable {accountName}?": "Sei sicuro di voler eliminare SeaTable {accountName}?",
    ...
    "Auto Deletion Setting": "Impostazione della cancellazione automatica",
    ...
    "Delete SeaTable base": "Elimina la base SeaTable",
    ...
    "Extended properties management": "Gestione estesa delle propriet\u00e0",
    ...
    "File extended properties": "Propriet\u00e0 estese del file",
    ...
    "Generate summary": "Genera sommario",
    ...
    "Grouped by xxx properties": " Raggruppati per xxx propriet\u00e0",
    "Groups": "Gruppi",
    "Guest": "Ospite",
    "Handled": "Mantenuto",
    "Help": "Aiuto",
    ...
    "Insufficient password strength": "Robustezza della password insufficiente",
    ...
    "Next": "Successivo",
    "No SeaTable bases": "Nessuna base SeaTable",
    ...
    "Preset filter": "Filtro preimpostato",
    "Preset filters": "Filtri preimpostati",
    "Preset hide properties": "Propriet\u00e0 nascoste preimpostate",
    "Preset sort": "Ordinamento preimpostato",
    ...
    "SeaTable API token": "Token API SeaTable",
    "SeaTable API token is required": "\u00c8 richiesto il token API SeaTable",
    "SeaTable base name": "Nome della base SeaTable",
    "SeaTable base name is required": "Il nome base SeaTable \u00e8 obbligatorio",
    "SeaTable integration": "Integrazione di SeaTable",
    "SeaTable server URL": "URL del server SeaTable",
    "SeaTable server URL is required": "L'URL del server SeaTable \u00e8 obbligatorio",
    "Seafile": "Seafile",
    "Search": "Ricerca",
    ...
    "Successfully connected to SeaTable": "Connessione a SeaTable riuscita",
    ...
    "URL or SeaTable API token is invalid": "L'URL o il token API SeaTable non sono validi",
    "US": "US",
    ...
    "preset sorts": "ordinamenti preimpostati",
    ...
    "xxx hidden properties": "xxx propriet\u00e0 nascoste",
    "xxx preset hidden properties": "xxx propriet\u00e0 nascoste preimpostate",
    ...
    "{placeholder} SeaTable integration": "{placeholder} Integrazione SeaTable",
