...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "A file named {upload_file_link} is uploaded.": "Se carga un archivo llamado {upload_file_link}.",
    "A file with the same name already exists in this folder.": "Ya existe un archivo con el mismo nombre en esta carpeta.",
    "A folder named {upload_folder_link} is uploaded to {uploaded_link}.": "Una carpeta llamada {upload_folder_link} se sube a {uploaded_link}.",
    "A folder named {upload_folder_link} is uploaded.": "Se carga una carpeta llamada {upload_folder_link}.",
    "AI": "IA",
    ...
    "Advanced": "Avanzado",
    "After": "Despu\u00e9s",
    "After connecting libraries, you can list files from them in the Wiki pages.": "Despu\u00e9s de conectar las bibliotecas, puede enumerar los archivos de ellas en las p\u00e1ginas Wiki.",
    ...
    "All comments ({comments_count})": "Todos los comentarios ({comments_count})",
    ...
    "An integer that is greater than 0.": "Un entero mayor que 0.",
    ...
    "Archive": "Archivar",
    "Archive library": "Archivar biblioteca",
    "Archived libraries will be moved to archive storage. Users will not be able to access the library during the archive process.": "Las bibliotecas archivadas se mover\u00e1n al almacenamiento de archivos. Los usuarios no podr\u00e1n acceder a la biblioteca durante el proceso de archivado.",
    ...
    "Are you sure you want to archive {placeholder} ?": "\u00bfEst\u00e1 seguro de que desea archivar {placeholder} ?",
    ...
    "Are you sure you want to delete this chat?": "\u00bfEst\u00e1 seguro de que desea eliminar esta charla?",
    ...
    "Are you sure you want to delete this webhook?": "\u00bfEst\u00e1 seguro de que desea eliminar este webhook?",
    ...
    "Are you sure you want to unarchive {placeholder} ?": "\u00bfEst\u00e1 seguro de que desea desarchivar {placeholder} ?",
    ...
    "Ask anything about your files": "Pregunte cualquier cosa sobre sus archivos",
    ...
    "Close metadata": "Cerrar metadatos",
    ...
    "Connect": "Conectar",
    "Connected libraries": "Bibliotecas conectadas",
    ...
    "Count": "Cuenta",
    "Cover": "Portada.",
    "Cover photo has been set": "La foto de portada ha sido establecida",
    "Create": "Crear",
    "Create At": "Creado el",
    ...
    "Created Folders": "Carpetas creadas",
    ...
    "Created {n} folders": "Creadas {n} carpetas",
    "Creator": "Creador",
    ...
    "Deleted Folders": "Carpetas eliminadas",
    ...
    "Deleted {n} {type}": "Eliminados {n} {type}",
    ...
    "Failed to copy %(name)s.": "Fallo al copiar %(name)s.",
    "Failed to copy QR code": "Error al copiar el c\u00f3digo QR",
    ...
    "Failed to modify row height": "Error al modificar la altura de fila",
    ...
    "File {file_link} has a new comment from user {author}.": "El archivo {file_link} tiene un nuevo comentario del usuario {author}.",
    "Files": "Archivos",
    ...
    "Folders": "Carpetas",
    "For security reasons, the password for the encrypted library is not stored on the server. If you forget it, you will not be able to recover the password.": "Por razones de seguridad, la contrase\u00f1a de la biblioteca cifrada no se almacena en el servidor. Si la olvida, no podr\u00e1 recuperar la contrase\u00f1a.",
    ...
    "Format": "Formato",
    "Found %1$d references": "Encontradas %1$d referencias",
    "Found 1 reference": "Encontrada 1 referencia",
    ...
    "Images wider than 1500 pixels work best.": "Las im\u00e1genes de m\u00e1s de 1500 p\u00edxeles de ancho funcionan mejor.",
    "Import": "Importar",
    ...
    "Manage all shares and share links in this library": "Gestionar todos los recursos compartidos y enlaces de uso compartido en esta biblioteca",
    ...
    "Mark notification as read": "Marcar la notificaci\u00f3n como le\u00edda",
    ...
    "Megaphone Icon": "Icono de meg\u00e1fono",
    "Member": "Miembro",
    "Members": "Miembros",
    ...
    "Month": "Mes",
    "Month:": "Mes:",
    "Monthly Traffic Limit": "L\u00edmite de tr\u00e1fico mensual",
    ...
    "Note, the library must turn on extended properties feature to be connected to a Wiki.": "Nota: la biblioteca debe activar la funci\u00f3n de propiedades extendidas para ser conectada a una Wiki.",
    ...
    "Open metadata": "Abrir metadatos",
    "Open parent folder": "Abrir carpeta contenedora",
    "Open the panel": "Abrir el panel",
    "Open with": "Abrir con",
    "Open with OnlyOffice": "Abrir con OnlyOffice",
    "Open with client": "Abrir con el cliente",
    "Operation": "Operaci\u00f3n",
    ...
    "Pre-render published wiki pages on the server so search engines can index their content more reliably.": "Prerenderizar las p\u00e1ginas wiki publicadas en el servidor para que los motores de b\u00fasqueda puedan indexar su contenido de forma m\u00e1s fiable.",
    "Precision": "Precisi\u00f3n",
    ...
    "QR code downloaded successfully": "C\u00f3digo QR descargado con \u00e9xito",
    "Quadruple": "Cu\u00e1druple",
    "Quota": "Cuota",
    "Quota is invalid.": "La cuota es inv\u00e1lida.",
    "Rate": "Calificaci\u00f3n",
    "Raw": "Crudo",
    "Raw file link": "Enlace del archivo crudo",
    "Raw file link is copied to the clipboard.": "El enlace del archivo crudo ha sido copiado al portapapeles.",
    ...
    "Rename Wiki to": "Cambiar el nombre de la wiki a",
    "Rename file": "Renombrar archivo",
    "Rename file to": "Cambiar el nombre del archivo a",
    "Rename folder": "Renombrar carpeta",
    "Rename folder to": "Renombrear la carpeta a",
    ...
    "Restored {n} items": "Restaurados {n} elementos",
    "Resubmit": "Reenviar",
    "Result": "Resultado",
    "Retry": "Reintentar",
    ...
    "SEO: Pre-render published pages": "SEO: Prerenderizar p\u00e1ginas publicadas",
    "SSO": "SSO",
    ...
    "Save to:": "Guardar en:",
    "Saving...": "Guardando...",
    "Scale menu": "Men\u00fa de escala",
    "SeaTable integration": "Integraci\u00f3n con SeaTable",
    "Seafile": "Seafile",
    "Seafile library": "Biblioteca Seafile",
    "Search": "Buscar",
    ...
    "Search users": "Buscar usuarios",
    "Search users...": "Buscar usuarios...",
    "Search wiki pages": "Buscar p\u00e1ginas wiki",
    "Search wikis": "Buscar wikis",
    "Searching...": "Buscando...",
    "Secret": "Secreto",
    "Select": "Seleccionar",
    ...
    "Select members from department": "Seleccionar miembros del departamento",
    "Select option(s)": "Seleccionar opci\u00f3n(es)",
    "Select row height": "Seleccionar altura de fila",
    ...
    "Send password separately": "Enviar contrase\u00f1a por separado",
    "Send to:": "Enviar a:",
    ...
    "Set Traffic": "Establecer tr\u00e1fico",
    ...
    "Set row height": "Establecer altura de fila",
    ...
    "Successfully set monthly traffic limit.": "L\u00edmite de tr\u00e1fico mensual establecido con \u00e9xito.",
    ...
    "Successfully starred {name_placeholder}": "\u00c9xito al a\u00f1adir la estrella a {name_placeholder}",
    ...
    "Successfully transferred the wiki.": "Wiki transferida con \u00e9xito.",
    ...
    "Successfully unstarred {name_placeholder}": "\u00c9xito al quitar la estrella de {name_placeholder}",
    ...
    "The content has been copied": "El contenido ha sido copiado",
    ...
    "The library is being archived. You will be notified once it is completed.": "La biblioteca est\u00e1 siendo archivada. Se le notificar\u00e1 una vez que se complete.",
    "The library is being unarchived. You will be notified once it is completed.": "La biblioteca est\u00e1 siendo desarchivada. Se le notificar\u00e1 una vez que se complete.",
    "The library will be moved back to primary storage. Users will not be able to access the library during the unarchive process.": "La biblioteca se mover\u00e1 de vuelta al almacenamiento principal. Los usuarios no podr\u00e1n acceder a la biblioteca durante el proceso de desarchivado.",
    ...
    "The number of metadata records exceeds the limit of {mdFileCountLimit} files.": "El n\u00famero de registros de metadatos supera el l\u00edmite de {mdFileCountLimit} archivos.",
    ...
    "This library has been archived, cannot be updated.": "Esta biblioteca ha sido archivada, no se puede actualizar.",
    ...
    "Tip: a snapshot will be generated after modification, which records the library state after the modification": "Consejo: se generar\u00e1 una instant\u00e1nea despu\u00e9s de la modificaci\u00f3n, que registra el estado de la biblioteca despu\u00e9s de la modificaci\u00f3n",
    ...
    "Toggle department group menu": "Alternar men\u00fa de grupo de departamento",
    ...
    "URL should start with http(s).": "La URL debe comenzar con http(s).",
    "US": "US",
    "Unarchive": "Desarchivar",
    "Unarchive library": "Desarchivar biblioteca",
    ...
    "When you set a secret, you will receive the X-Seafile-Signature header in the webhook POST request, which is the SHA256 encryption result of the secret and request.body.": "Cuando configure un secreto, recibir\u00e1 el encabezado X-Seafile-Signature en la solicitud POST del webhook, que es el resultado del cifrado SHA256 del secreto y request.body.",
    ...
    "You can also press \u2190 ": "Tambi\u00e9n puede pulsar \u2190 ",
    "You can also press \u2192": "Tambi\u00e9n puede pulsar \u2192",
    ...
    "You do not have permission to access Trash.": "No tiene permiso para acceder a la Papelera.",
    ...
    "{folder} and {n} other folders": "{folder} y otras {n} carpetas",
    ...
    "{name} and {n} other files": "{name} y otros {n} archivos",
    "{name} and {n} other folders": "{name} y otras {n} carpetas",
    ...
    "{user} renamed file {oldFileName} to {fileName} in library {libraryName}.": "{user} renombr\u00f3 el archivo {oldFileName} a {fileName} en la biblioteca {libraryName}.",
    "{user} renamed folder {oldFolderName} to {folderName} in library {libraryName}.": "{user} renombr\u00f3 la carpeta {oldFolderName} a {folderName} en la biblioteca {libraryName}.",
