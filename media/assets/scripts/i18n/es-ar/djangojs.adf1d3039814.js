...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "(at least {passwordLength} characters and has {shareLinkPasswordStrengthLevel} of the following: num, upper letter, lower letter and other symbols)": "(por lo menos {passwordLength} caracteres y contiene  {shareLinkPasswordStrengthLevel} de los siguientes: n\u00fameros, may\u00fasculas, min\u00fasculas y otros s\u00edmbolos)",
    ...
    "Password is too weak, should have at least {shareLinkPasswordStrengthLevel} of the following: num, upper letter, lower letter and other symbols": "La contrase\u00f1a es demasiado d\u00e9bil, deberia contener por lo menos  {shareLinkPasswordStrengthLevel} de los siguientes: n\u00fameros, may\u00fasculas, min\u00fasculas y otros s\u00edmbolos",
    "Password:": "Contrase\u00f1a:",
