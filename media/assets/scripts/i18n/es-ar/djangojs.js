...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Disable SAML user email / password login": "Deshabilitar inicio de sesi\u00f3n con correo electr\u00f3nico/contrase\u00f1a de usuario SAML",
    ...
    "Force user to use SSO login if SAML account is bound": "Forzar al usuario a usar inicio de sesi\u00f3n SSO si la cuenta SAML est\u00e1 vinculada",
    ...
    "Please choose a .sdoczip file.": "Por favor, elija un archivo .sdoczip.",
    ...
    "Search failed, please enter detailed address.": "B\u00fasqueda fallida, por favor ingrese una direcci\u00f3n detallada.",
