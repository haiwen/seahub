...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "A file named {upload_file_link} is uploaded.": "Un archivo llamado {upload_file_link} es subido.",
    "A file with the same name already exists in this folder.": "Ya existe un archivo con el mismo nombre en esta carpeta.",
    "A folder named {upload_folder_link} is uploaded to {uploaded_link}.": "Una carpeta llamada {upload_folder_link} es subida a {uploaded_link}.",
    "A folder named {upload_folder_link} is uploaded.": "Una carpeta llamada {upload_folder_link} es subida.",
    "AI": "IA",
    ...
    "Added": "Agregado",
    "Added a new comment in document {sdoc_link}:": "Added a new comment in document {sdoc_link}:",
    "Added a new reply in document {sdoc_link}:": "Added a new reply in document {sdoc_link}:",
    ...
    "Allow users to clean library trash": "Permitir al usuario vaciar la papelera de la biblioteca",
    ...
    "Are you sure you want to clean invalid share links?": "\u00bfEst\u00e1 seguro de que desea limpiar los enlaces de compartir inv\u00e1lidos?",
    "Are you sure you want to clean invalid upload links?": "\u00bfEst\u00e1 seguro de que desea limpiar los enlaces de subida inv\u00e1lidos?",
    ...
    "Are you sure you want to delete Wiki": "\u00bfEst\u00e1 seguro de que desea eliminar el Wiki?",
    ...
    "Are you sure you want to leave share Wiki": "\u00bfEst\u00e1 seguro de que desea dejar el Wiki compartido?",
    ...
    "Are you sure you want to set {user_placeholder} inactive?": "\u00bfEst\u00e1 seguro que desea desactivar a {user_placeholder}?",
    ...
    "Are you sure you want to unpublish Wiki": "\u00bfEst\u00e1 seguro de que desea despublicar el Wiki?",
    ...
    "Ascending by role": "Ordenar ascendentemente por rol",
    "Ascending by size": "Ascendente por tama\u00f1o",
    "Ascending by space used": "Ordenar por espacio utilizado de forma ascendente",
    "Ascending by time": "Ascendente por tiempo",
    ...
    "Authenticated emails": "Correos autenticados",
    ...
    "By child tags count ascending": "Por conteo de etiquetas hijas ascendente",
    "By child tags count descending": "Por conteo de etiquetas hijas descendente",
    "By day": "Por d\u00eda",
    "By file count ascending": "Por conteo de archivos ascendente",
    "By file count descending": "Por conteo de archivos descendente",
    "By month": "Por mes",
    ...
    "Cannot move parent page to child page": "No se puede mover p\u00e1gina padre a p\u00e1gina hija",
    ...
    "Child tags count": "Conteo de etiquetas hijas",
    "Choose date": "Escoja fecha",
    "Clean": "Limpiar",
    "Clean invalid share links": "Limpiar enlaces de compartir inv\u00e1lidos",
    "Clean invalid upload links": "Limpiar enlaces de subida inv\u00e1lidos",
    ...
    "Clear selected": "Limpiar seleccionado",
    "Clients": "Clientes",
    "Close": "Cerrar",
    ...
    "Configure your Identity Provider": "Configurar su Proveedor de Identidad",
    "Confirm": "Confirmar",
    ...
    "Copy the domain DNS TXT and add it to your domain's DNS records, then click the button to verify domain ownership. You must verify the ownership of domain before Single Sign-On.": "Copie el valor DNS TXT y agr\u00e9guelo a los registros DNS de su dominio. Luego haga clic en el bot\u00f3n para verificar la propiedad del dominio. Debe verificar la propiedad del dominio antes de activar el inicio de sesi\u00f3n \u00fanico.",
    ...
    "Create a DNS TXT record to confirm the ownership of your Email Domain.": "Cree un registro DNS TXT para confirmar la propiedad de su dominio de correo electr\u00f3nico.",
    ...
    "Descending by files": "Ordenar descendentemente por archivos",
    "Descending by name": "Descendente por nombre",
    "Descending by role": "Ordenar descendentemente por rol",
    "Descending by size": "Descendente por tama\u00f1o",
    "Descending by space used": "Ordenar por espacio utilizado de forma descendente",
    "Descending by time": "Descendente por tiempo",
    ...
    "Disable SSO user email / password login": "Deshabilitar inicio de sesi\u00f3n por correo/contrase\u00f1a para usuarios SSO",
    ...
    "Disable user clean trash": "Deshabilitar limpieza de papelera por usuario",
    ...
    "Do you really want to turn off extended properties? Existing properties will all be deleted.": "\u00bfRealmente desea desactivar las propiedades extendidas? Todas las propiedades existentes ser\u00e1n eliminadas.",
    "Do you really want to turn off tags? Existing tags will all be deleted.": "\u00bfRealmente desea desactivar las etiquetas? Todas las etiquetas existentes ser\u00e1n eliminadas.",
    "Do you want to keep the library sharing relationships?": "\u00bfDeseas mantener las relaciones de compartici\u00f3n de bibliotecas?",
    "Document": "Documento",
    "Document conversion failed.": "Error en la conversi\u00f3n del documento.",
    ...
    "Enable departments feature": "Habilitar la caracter\u00edstica de departamentos",
    ...
    "Enable tags to add tags to files and search files by tags.": "Habilite etiquetas para agregar etiquetas a archivos y buscar archivos por etiquetas.",
    ...
    "Enter custom currency symbol": "Ingresar s\u00edmbolo de moneda personalizado",
    ...
    "Extract file detail": "Extraer detalle de archivo",
    "Extract file details": "Extraer detalles del archivo",
    "Extract text": "Extraer texto",
    "Extracting file details by AI...": "Extrayendo detalles de archivo por IA...",
    ...
    "Failed": "Fall\u00f3",
    "Failed imported options": "Opciones importadas fallidas",
    ...
    "Failed to extract file details": "Error al extraer detalles de archivo",
    ...
    "Failed to merge tags": "Error al fusionar etiquetas",
    ...
    "Failed to modify settings": "Error al modificar configuraciones",
    ...
    "File collaborators": "Colaboradores de archivo",
    "File count": "Conteo de archivos",
    "File details": "Detalles del archivo",
    "File details extracted": "Detalles de archivo extra\u00eddos",
    ...
    "File expire time": "Tiempo de expiraci\u00f3n de archivo",
    "File extension white list": "Lista blanca de extensiones de archivo",
    "File extension white list for file upload via web UI and API. For example, \"md;txt;docx\". Empty means no limit.": "Lista blanca de extensiones de archivo para carga a trav\u00e9s de la interfaz web y API. Por ejemplo, \"md;txt;docx\". Vac\u00edo significa sin l\u00edmite.",
    ...
    "File name only": "S\u00f3lo nombre del archivo",
    "File owner": "Propietario del archivo",
    "File rate": "Calificaci\u00f3n del archivo",
    "File reviewer": "Revisor de archivo",
    ...
    "Fold": "Colapsar",
    "Fold the sidebar": "Ocultar barra lateral",
    "Folder": "Carpeta",
    ...
    "Grouped by {name_placeholder} properties": "Agrupado por propiedades {name_placeholder}",
    "Groups": "Grupos",
    "Guest": "Invitado",
    "Handled": "Manejado",
    "Help": "Ayuda",
    ...
    "Leave group": "Abandonar el grupo",
    "Leave this page? The system may not save your changes.": "\u00bfDejar esta p\u00e1gina? El sistema puede no guardar sus cambios.",
    ...
    "Merge tags to": "Fusionar etiquetas a",
    "Message": "Mensaje",
    "Metadata": "Metadatos",
    "Metrics": "M\u00e9tricas",
    "Migrate": "Migrar",
    "Migrate User": "Migrar Usuario",
    "Migrate old version tags": "Migrar etiquetas de versi\u00f3n anterior",
    "Mine": "M\u00edas",
    "Mobile": "M\u00f3vil",
    ...
    "Name cannot be double dots": "El nombre no puede ser dos puntos",
    ...
    "No group shares": "No hay compartidas con grupos",
    ...
    "No linked devices. You have not accessed your files with any client (desktop or mobile) yet. Configure clients on your devices to access your data more comfortably.": "No hay dispositivos vinculados. No ha accedido a sus archivos con ning\u00fan cliente (escritorio o m\u00f3vil) a\u00fan. Configure clientes en sus dispositivos para acceder a sus datos de manera m\u00e1s c\u00f3moda.",
    ...
    "No public libraries have been created yet. A public library is accessible by all users. You can create a public library by clicking the \"Add Library\" item in the dropdown menu.": "A\u00fan no se han creado bibliotecas p\u00fablicas. Una biblioteca p\u00fablica es accesible por todos los usuarios. Puedes crear una biblioteca p\u00fablica haciendo click en el \u00edtem \"Agregar Biblioteca\" en el men\u00fa desplegable.",
    "No recommended new tags": "No hay nuevas etiquetas recomendadas",
    "No record": "No hay registros",
    ...
    "No user shares": "No hay compartidas con usuarios",
    "No users found": "No se encontraron usuarios",
    "No version history": "No hay historial de versiones",
    ...
    "Please enter an integer bigger than 1 as number of links.": "Ingresa un entero mayor que 1 como n\u00famero de enlaces.",
    "Please enter an integer not bigger than {max_number} as number of links.": "Ingresa un entero no mayor que {max_number} como n\u00famero de enlaces.",
    ...
    "Removed all items from trash": "Se eliminaron todos los elementos de la papelera",
    "Removed items older than {n} days from trash": "Se eliminaron los elementos m\u00e1s antiguos de {n} d\u00edas de la papelera",
    "Rename": "Renombrar",
    ...
    "Rename Wiki to": "Renombrar Wiki a",
    "Rename file": "Renombrar archivo",
    "Rename file to": "Renombrar archivo a",
    "Rename folder": "Renombrar carpeta",
    "Rename folder to": "Renombrar carpeta a",
    ...
    "Restored {name}": "Restaurado con \u00e9xito {name}.",
    "Restored {name} and {n} other items": "Restaurado con \u00e9xito {name} y {n} otros elementos.",
    ...
    "Search service unavailable": "Servicio de b\u00fasqueda no disponible",
    ...
    "Share links cannot be generated because \"Invisible\", \"Online Read-Write\" or \"Online Read-Only\" is set for you on some folder(s) in the library.": "No se pueden generar enlaces de compartir porque \"Invisible\", \"Online Read-Write\" o \"Online Read-Only\" est\u00e1n configurados para ti en alguna carpeta de la biblioteca.",
    ...
    "Sharing Time": "Tiempo de Compartida",
    "Show": "Mostrar",
    ...
    "Successfully cleaned invalid share links.": "Enlaces de compartir inv\u00e1lidos limpiados exitosamente.",
    "Successfully cleaned invalid upload links.": "Enlaces de subida inv\u00e1lidos limpiados exitosamente.",
    "Successfully cleared trash.": "Papelera vaciada con \u00e9xito.",
    "Successfully converted the file.": "Archivo convertido con \u00e9xito.",
    ...
    "Successfully copied {name} and {n} other items": "Copiado con \u00e9xito {name} y {n} otros elementos.",
    "Successfully deleted 1 item": "1 \u00edtem eliminado con \u00e9xito",
    "Successfully deleted 1 item.": "1 \u00edtem eliminado con \u00e9xito",
    "Successfully deleted 1 share link": "Se elimin\u00f3 con \u00e9xito 1 enlace de compartir",
    ...
    "Successfully deleted {number_placeholder} share links": "Se eliminaron con \u00e9xito {number_placeholder} enlaces de compartir",
    ...
    "Successfully imported tags.": "Etiquetas importadas exitosamente.",
    ...
    "Successfully moved {name} and {n} other items": "Movido con \u00e9xito {name} y {n} otros elementos.",
    ...
    "Tags": "R\u00f3tulos",
    "Tags migrated successfully": "Etiquetas migradas exitosamente",
    ...
    "The content of the document has exceeded the limit of 100000 characters, and the content cannot be saved": "El contenido del documento ha excedido el l\u00edmite de 100000 caracteres y el contenido no se puede guardar",
    ...
    "The past numbers of days": "Los n\u00fameros pasados de d\u00edas",
    ...
    "There is another option with this name": "Otra opci\u00f3n tiene este nombre",
    ...
    "This library contains tags of old version. Do you like to migrate the tags to new version?": "Esta biblioteca contiene etiquetas de la versi\u00f3n anterior. \u00bfLe gustar\u00eda migrar las etiquetas a la nueva versi\u00f3n?",
    ...
    "Traffic": "Tr\u00e1fico",
    "Traffic exceeded": "L\u00edmite de tr\u00e1fico excedido",
    ...
    "Type": "Tipo",
    "Type characters to start search": "Escribe caracteres para comenzar la b\u00fasqueda",
    "URL": "URL",
    ...
    "Undo": "Deshacer",
    "Unfold": "Descolapsar",
    "Unfold the sidebar": "Desplegar barra lateral",
    ...
    "Use information from your Identity Provider to configure Seafile": "Use la informaci\u00f3n de su Proveedor de Identidad para configurar Seafile",
    "Use the import/export function to transfer options quickly. (The export is in JSON format.) By pasting cells, copied from a text column, an Excel or a TXT file, you can also add options quickly.": "Use la funci\u00f3n de importar/exportar para transferir opciones r\u00e1pidamente. (La exportaci\u00f3n est\u00e1 en formato JSON.) Al pegar celdas, copiadas de una columna de texto, un Excel o un archivo TXT, tambi\u00e9n puede agregar opciones r\u00e1pidamente.",
    "Use these values to configure your Identity Provider": "Use estos valores para configurar su Proveedor de Identidad",
    "Used:": "Utilizado:",
    "User": "Usuario",
    ...
    "Visit the wiki": "Visitar el wiki",
    "Visited": "Visitado",
    "Visits": "Visitas",
    "Waiting...": "Esperando...",
    ...
    "You can also press \u2192": "Tambi\u00e9n puede pulsar \u2192",
    "You can click the \"Add Wiki\" button below to add a new Wiki.": "Puede hacer clic en el bot\u00f3n \"Agregar Wiki\" a continuaci\u00f3n para agregar un nuevo Wiki.",
    "You can create files quickly": "Puedes crear archivos r\u00e1pidamente",
    "You can create libraries by clicking the \"New Library\" item in the dropdown menu.": "Crea bibliotecas haciendo clic en el elemento \"Nueva Biblioteca\" en el men\u00fa desplegable.",
    ...
    "You have not created any libraries yet. A library is a container to organize your files and folders. A library can also be shared with others and synced to your connected devices. You can create a library by clicking the \"New Library\" item in the dropdown menu.": "Puede crear una biblioteca haciendo clic en el elemento \"Nueva Biblioteca\" en el men\u00fa desplegable.",
