...
export const disableOrgEncryptedLibrary = window.app.pageOptions.disableOrgEncryptedLibrary;
...
export const disableOrgUserCleanTrash = window.app.pageOptions.disableOrgUserCleanTrash;
