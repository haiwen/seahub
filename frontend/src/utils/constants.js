...
export const shareLinkForceExpiration = window.app.pageOptions.shareLinkForceExpiration;
...
export const uploadLinkForceExpiration = window.app.pageOptions.uploadLinkForceExpiration;
