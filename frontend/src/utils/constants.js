...
export const enableOrgEncryptedLibrary = window.app.pageOptions.enableOrgEncryptedLibrary;
...
export const enableOrgUserCleanTrash = window.app.pageOptions.enableOrgUserCleanTrash;
