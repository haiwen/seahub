...
class ChatAPI {
  ...
  approveSdocReview(taskId) {
    return this.req.post(this.server + '/api/v2.1/ai/sdoc-reviews/' + taskId + '/approve/');
  }

  rejectSdocReview(taskId) {
    return this.req.post(this.server + '/api/v2.1/ai/sdoc-reviews/' + taskId + '/reject/');
  }
}
