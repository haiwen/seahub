...
import { VIEW_NOT_DISPLAY_COLUMN_KEYS, VIEW_TYPE_DEFAULT_BASIC_FILTER, VIEW_TYPE, VIEW_TYPE_DEFAULT_SORTS, VIEW_DEFAULT_SETTINGS, VIEW_DEFAULT_AVAILABLE_COLUMN_KEYS } from '../../constants';
...
class View {
  ...
  constructor(object, columns) {
    ...
    // columns
    this.available_column_keys = object.available_column_keys && object.available_column_keys.length > 0 ? object.available_column_keys : VIEW_DEFAULT_AVAILABLE_COLUMN_KEYS;
