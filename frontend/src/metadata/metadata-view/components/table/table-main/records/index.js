...
class Records extends Component {
  ...
  renderRecordsBody = ({ containerWidth }) => {
    const { isGroupView, recordGetterByIndex, modifySdocSummary } = this.props;
    ...
    const commonProps = {
      ...
      contextMenu: (<ContextMenu isGroupView={isGroupView} recordGetterByIndex={recordGetterByIndex} modifySdocSummary={modifySdocSummary} />),
