export const OPERATION_TYPE = {
  ...
  BATCH_MOVE_RECORDS: 'batch_move_records',
  BATCH_DUPLICATE_RECORDS: 'batch_duplicate_records',
...
export const OPERATION_ATTRIBUTES = {
  ...
  [OPERATION_TYPE.BATCH_MOVE_RECORDS]: ['repo_id', 'row_ids', 'target_repo_id', 'dirents', 'target_parent_path', 'source_parent_path', 'update_data'],
  [OPERATION_TYPE.BATCH_DUPLICATE_RECORDS]: ['repo_id', 'row_ids', 'target_repo_id', 'dirents', 'target_parent_path', 'source_parent_path'],
...
export const NEED_APPLY_AFTER_SERVER_OPERATION = [
  ...
  OPERATION_TYPE.BATCH_MOVE_RECORDS,
  OPERATION_TYPE.BATCH_DUPLICATE_RECORDS,
];
