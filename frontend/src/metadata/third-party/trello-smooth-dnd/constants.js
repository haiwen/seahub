...
export const defaultGrabHandleClass = 'smooth-dnd-default-grab-handle';
...
export const isDraggableDetached = 'smooth-dnd-is-draggable-detached';

export const disableTouchActions = 'smooth-dnd-disable-touch-action';
