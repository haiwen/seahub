      ...
      <Modal isOpen={true} toggle={this.toggle} autoFocus={false}>
        ...
        <ModalBody style={{ height: '250px' }} className="o-auto">
          <div className="d-flex">
            ...
            <button type="submit" className={`btn btn-primary flex-shrink-0 ${isSubmitting ? 'btn-loading' : ''}`} onClick={this.searchFile} onKeyDown={Utils.onKeyDown} disabled={isSubmitDisabled}>{gettext('Search')}</button>
          </div>
