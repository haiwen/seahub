...
import ShareWithOCM from './share-with-ocm';
      ...
      <Fragment>
        <div className="share-dialog-side">
          <Nav pills vertical>
            ...
            {enableOCM && itemType === 'library' &&
              <NavItem>
                <NavLink className={activeTab === 'shareWithOCM' ? 'active' : ''} onClick={this.toggle.bind(this, 'shareWithOCM')}>
        ...
        <div className="share-dialog-main">
          <TabContent activeTab={this.state.activeTab}>
            ...
            {enableOCM && itemType === 'library' && activeTab === 'shareWithOCM' &&
              <TabPane tabId="shareWithOCM">
                <ShareWithOCM itemType={this.props.itemType} isGroupOwnedRepo={this.props.isGroupOwnedRepo} itemPath={this.props.itemPath} repoID={this.props.repoID} isRepoOwner={this.state.isRepoOwner} />
              </TabPane>
            }
          </TabContent>
        </div>
