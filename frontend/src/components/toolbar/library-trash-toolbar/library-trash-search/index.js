...
const Search = () => {
  ...
  const handleClickOutside = useCallback((event) => {
    ...
    if (event.target.closest('.library-trash-filter-icon') || event.target.closest('.library-trash-filter-popover')) {
      return;
    }
    ...
    <div className="sf-metadata-tool">
      <div className="sf-metadata-tool-left-operations">
        ...
        <IconBtn
          ...
          size={24}
          className={classnames('sf-metadata-view-tool-operation-btn sf-metadata-view-tool-filter library-trash-filter-icon', { 'active': isFiltersActive })}
        ...
        <UncontrolledPopover
          ...
          fade={false}
          hideArrow={true}
          className="sf-metadata-filter-popover library-trash-filter-popover"
