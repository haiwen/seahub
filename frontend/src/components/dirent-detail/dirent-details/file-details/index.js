...
const FileDetails = React.memo(({ repoID, dirent, path, direntDetail, isShowRepoTags = true, repoTags, fileTagList, readOnly = false, tagsData, addTag, onFileTagChanged }) => {
  ...
  const dom = (
    <>
      ...
      {enableMetadata && <MetadataDetails readOnly={readOnly} tagsData={tagsData} addTag={addTag} />}
    </>
  );
