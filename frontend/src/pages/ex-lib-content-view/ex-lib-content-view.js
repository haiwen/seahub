...
import ExLibContentToolbar from './ex-lib-content-toolbar';
import ExLibContentContainer from './ex-lib-content-container';
...
class ExLibContentView extends React.Component {
  ...
  showDir = (path) => {
    ...
    let url = siteRoot + 'ex-library/' + repoID + '/' + encodeURIComponent(repoInfo.repo_name) + Utils.encodePath(path);
...
ExLibContentView.propTypes = propTypes;

export default ExLibContentView;
