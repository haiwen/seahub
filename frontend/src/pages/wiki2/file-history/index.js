...
const { repoID, assetsUrl, seadocAccessToken, seadocServerUrl, wikiConfig } = window.fileHistory.pageOptions;
const { name: fileName, path: filePath, docUuid } = JSON.parse(wikiConfig);
...
class WikiFileHistory extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={`wiki-file-history d-flex ${isMobile ? 'mobile' : ''}`}>
