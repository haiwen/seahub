    ...
    const menuItems = [
      {
        ...
        icon_dom: <Icon symbol="copy" aria-hidden="true" />,
        onClick: this.handleCopyLink,
      },
      {
        key: 'rename',
        label: gettext('Modify name'),
        icon_dom: <Icon symbol="rename" aria-hidden="true" />,
        onClick: this.onRename,
      },
      {
        key: 'add-page-above',
        label: gettext('Add page above'),
        icon_dom: <Icon symbol="new" aria-hidden="true" />,
      ...
      'Divider',
      {
        ...
        icon_dom: <Icon symbol="open-in-new-tab" aria-hidden="true" />,
