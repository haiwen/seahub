...
import FileView from './history-trash-file-view/file-view';
import FileViewTip from './history-trash-file-view/file-view-tip';
...
export default HistoryTrashFileView;
