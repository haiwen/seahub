...
import ExlibRepoMenu from './exlib-repo-menu';
...
class ExlibRepoListItem extends React.Component {
  ...
  renderPCUI = () => {
    ...
    let repoURL = `${siteRoot}ex-library/${repo.repo_id}/${Utils.encodePath(repo.repo_name)}/`;
    return (
...
ExlibRepoListItem.propTypes = propTypes;

export default ExlibRepoListItem;
