...
import ExlibRepoListItem from './exlib-repo-list-item';
...
class ExlibRepoListView extends React.Component {
...
ExlibRepoListView.propTypes = propTypes;

export default ExlibRepoListView;
