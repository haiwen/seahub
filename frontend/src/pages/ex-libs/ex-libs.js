...
import ExlibRepoListView from './exlib-repo-list-view';
...
class ExLibraries extends Component {
  constructor(props) {
    super(props);
    this.state = {
      errorMsg: '',
  ...
  componentDidMount() {
    customAPI.listExRepos().then((res) => {
  ...
  onCreateRepo = (repo) => {
    customAPI.createRepo(repo, true).then((res) => {
    ...
    return (
      <Fragment>
        <div className="main-panel-north border-left-show">
          <RepoViewToolbar onShowSidePanel={this.props.onShowSidePanel} onCreateRepo={this.onCreateRepo} libraryType={'external'}/>
          <CommonToolbar onSearchedClick={this.props.onSearchedClick} />
        </div>
        <div className="main-panel-center flex-row">
          <div className="cur-view-container">
            <div className="cur-view-path">
              <h3 className="sf-heading m-0">{'外部资料库'}</h3>
...
ExLibraries.propTypes = propTypes;

export default ExLibraries;
