              ...
              <dl className="flex-1 m-0">
                ...
                {isPro ?
                  ...
                  <dd className="info-item-content">
                    ...
                    <a className="ml-1" href="https://manual.seafile.com/11.0/deploy_pro/migrate_from_seafile_community_server/" target="_blank" rel="noreferrer">{gettext('Upgrade to Pro Edition')}</a>
                  </dd>
                }
