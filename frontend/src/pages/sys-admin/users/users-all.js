...
import { username, availableRoles } from '../../../utils/constants';
...
class Content extends Component {
  ...
  render() {
    const { loading, errorMsg, items, pageInfo, isAllUsersSelected, curPerPage, hasNextPage, currentPage } = this.props;
    if (loading) {
      return <Loading />;
    } else if (errorMsg) {
...
const propTypes = {
  isLDAPImportUsers: PropTypes.boolean
};
...
class UsersAll extends Component {
  ...
  getUsersListByPage = (page) => {
    ...
    seafileAPI.sysAdminListAllUsers(page, perPage, this.props.isLDAPImportUsers).then(res => {
      ...
      <Fragment>
        ...
        <div className="main-panel-center flex-row">
          <div className="cur-view-container">
            {this.props.isLDAPImportUsers ?
              <UsersNav currentItem="ldapimport" /> :
