            ...
            <thead>
              <tr>
                <th width="3%" className="pl-2">
                  <input type="checkbox" className="form-check-input" onChange={this.props.toggleSelectAllUsers} checked={isAllUsersSelected} />
                </th>
    ...
    return (
      <Fragment>
        <tr className={this.state.highlight ? 'tr-highlight' : ''} onMouseEnter={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave}>
          <td className="pl-2">
            <input type="checkbox" className="form-check-input" onChange={this.onUserSelected} checked={item.isSelected} />
          </td>
          <td>
