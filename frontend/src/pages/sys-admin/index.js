...
import StatisticLayout from './statistic';
import Logs from './sys-logs';
import FileAccessLogs from './sys-logs/file-access-logs';
import FIleTransferLogs from './sys-logs/file-transfer-log';
import FileUpdateLogs from './sys-logs/file-update-logs';
import GroupMemberAuditLogs from './sys-logs/group-member-audit-logs';
import LoginLogs from './sys-logs/login-logs';
import SharePermissionLogs from './sys-logs/share-permission-logs';
