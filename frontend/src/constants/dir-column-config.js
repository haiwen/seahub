...
export const DIR_BASE_COLUMNS = [
  { key: DIR_COLUMN_KEYS.FILE_NAME, name: gettext('Name'), type: CellType.FILE_NAME },
  ...
  { key: DIR_COLUMN_KEYS.FILE_MODIFIER, name: gettext('Last modifier'), type: CellType.LAST_MODIFIER }
];

export const CONFIGURABLE_COLUMNS = [
  DIR_COLUMN_KEYS.SIZE,
  DIR_COLUMN_KEYS.MTIME,
  DIR_COLUMN_KEYS.FILE_MODIFIER,
  PRIVATE_COLUMN_KEY.FILE_CREATOR,
  PRIVATE_COLUMN_KEY.FILE_STATUS,
  PRIVATE_COLUMN_KEY.TAGS,
];

export const LIST_VIEW_HIDDEN_COLUMNS_DEFAULT = [
  DIR_COLUMN_KEYS.FILE_MODIFIER,
  PRIVATE_COLUMN_KEY.FILE_CREATOR,
  PRIVATE_COLUMN_KEY.FILE_STATUS,
  PRIVATE_COLUMN_KEY.TAGS,
...
// Table sort keys - per repo
export const getDirTableSortByKey = (repoID) => `sf_dir_table_sort_by_${repoID}`;
export const getDirTableSortOrderKey = (repoID) => `sf_dir_table_sort_order_${repoID}`;
