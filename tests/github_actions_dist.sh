...
git clone --depth=1 --branch=8.0 https://github.com/haiwen/seafile-server.git /tmp/repositories/seafile-server
git clone --depth=1 https://github.com/haiwen/ccnet-server.git /tmp/repositories/ccnet-server
git clone --depth=1 --branch=8.0 https://github.com/haiwen/libsearpc.git /tmp/repositories/libsearpc
