...
git clone --depth=1 --branch=8.0 git://github.com/haiwen/seafile-server.git /tmp/repositories/seafile-server
git clone --depth=1 git://github.com/haiwen/ccnet-server.git /tmp/repositories/ccnet-server
git clone --depth=1 --branch=8.0 git://github.com/haiwen/libsearpc.git /tmp/repositories/libsearpc
