...
DROP INDEX "drafts_draft_origin_file_uuid_uniq";
ALTER TABLE "drafts_draft"
    ADD CONSTRAINT "drafts_draft_origin_file_uuid_uniq" UNIQUE ("origin_file_uuid");
CREATE INDEX "drafts_draft_origin_repo_id" ON "drafts_draft" ("origin_repo_id");
